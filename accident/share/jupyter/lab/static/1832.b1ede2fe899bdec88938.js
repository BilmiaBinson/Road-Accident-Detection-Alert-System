              ...
              6: (e, t) => {
                ...
                (Object.defineProperty(t, "__esModule", { value: !0 }),
                  ...
                  (t.WebLinkProvider = class {
                    ...
                    provideLinks(e, t) {
                      const n = r.computeLink(e, this._regex, this._terminal, this._handler);
                ...
                class r {
                  static computeLink(e, t, i, o) {
                    ...
                    for (; (p = s.exec(c)); ) {
                      ...
                      if (-1 === t || -1 === s || -1 === a || -1 === c) continue;
                      const h = { start: { x: s + 1, y: t + 1 }, end: { x: c, y: a + 1 } };
                  ...
                  static _getWindowedLineStrings(e, t) {
                    ...
                    if ((n = t.buffer.active.getLine(e))) {
                      ...
                      for (
                        ...
                        n.isWrapped &&
                        o < 2048 &&
                        ((s = n.translateToString(!0)), (o += s.length), a.push(s), -1 === s.indexOf(" "));
                    ...
                    for (; r; ) {
                      ...
                      for (let n = s; n < e.length; ++n) {
                        ...
                        if (o.getWidth() && ((r -= s.length || 1), n === e.length - 1 && "" === s)) {
                          ...
                          e && e.isWrapped && (e.getCell(0, o), 2 === o.getWidth() && (r += 1));
                        }
                        if (r < 0) return [t, n];
                      }
                      (t++, (s = 0));
