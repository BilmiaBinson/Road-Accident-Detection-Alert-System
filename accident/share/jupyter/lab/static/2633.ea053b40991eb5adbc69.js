        ...
        function w(t, e, r, n, i, o) {
          ...
          if (i) {
            ...
            f = u.create(
              ...
              "mo",
              [],
              { fence: true, stretchy: true, symmetric: true, texClass: a.TEXCLASS.OPEN },
              h,
            );
          }
          ...
          if (i) {
            ...
            f = u.create(
              ...
              "mo",
              [],
              { fence: true, stretchy: true, symmetric: true, texClass: a.TEXCLASS.CLOSE },
              p,
            );
          }
          ...
          for (var r = 0, n = e.length; r < n; r++) {
            ...
            if (
              ...
              (!s.default.isType(i, "TeXAtom") ||
                (s.default.getChildren(i)[0] && s.default.getChildren(s.default.getChildren(i)[0]).length))
            ) {
              if (
      ...
      var u = (function () {
        ...
        t.prototype.makeId = function () {
          this.currentTag.tagId = this.formatId(
            this.configuration.options["useLabelIds"] ? this.label || this.currentTag.tag : this.currentTag.tag,
          );
        };
