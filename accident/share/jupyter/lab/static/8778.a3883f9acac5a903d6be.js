  ...
  [8778, 5606],
  {
          ...
          function (e, r, n) {
                  ...
                  if ("function" != typeof n) {
                    for (var s in n)
                      if (Object.prototype.hasOwnProperty.call(n, s)) {
                        ...
                        e.register(o, s, "/home/adele/workspace/react-paginate/react_components/PageView.js");
                      }
                  } else
                    e.register(
                      n,
            ...
            var f = function (e) {
              ...
              return o.a.createElement(
                "li",
                { className: i },
                o.a.createElement("a", p({ className: n, role: "button", tabIndex: "0", onKeyPress: s }, a(s)), t),
              );
            };
            f.propTypes = {
            ...
            function R(e) {
              if (void 0 === e) throw new ReferenceError("this hasn't been initialized - super() hasn't been called");
              return e;
            }
            function $(e) {
                  ...
                  if ("function" != typeof n) {
                    for (var s in n)
                      if (Object.prototype.hasOwnProperty.call(n, s)) {
                        ...
                        e.register(o, s, "/home/adele/workspace/react-paginate/react_components/BreakView.js");
                      }
                  } else
                    e.register(
                      n,
            ...
            var I = (function (e) {
              ...
              function a(e) {
                ...
                return (
                  ...
                  N(R((t = s.call(this, e))), "handlePreviousPage", function (e) {
                  ...
                  N(R(t), "pagination", function () {
                    var e = [],
                      ...
                      u = t.state.selected;
                    if (s <= n) for (var p = 0; p < s; p++) e.push(t.getPageElement(p));
                    else {
                      var f,
                        E,
                        m,
                        d = n / 2,
                        g = n - d;
                      u > s - n / 2 ? (d = n - (g = s - u)) : u < n / 2 && (g = n - (d = u));
                      var v = function (e) {
                        return t.getPageElement(e);
                      };
                      for (f = 0; f < s; f++)
                        (E = f + 1) <= a || E > s - a || (f >= u - d && f <= u + g)
                          ? e.push(v(f))
                          : i &&
                            e[e.length - 1] !== m &&
                  ...
                  if ("function" != typeof n) {
                    for (var s in n)
                      if (Object.prototype.hasOwnProperty.call(n, s)) {
                        ...
                        e.register(o, s, "/home/adele/workspace/react-paginate/react_components/index.js");
                      }
                  } else
                    e.register(n, "module.exports", "/home/adele/workspace/react-paginate/react_components/index.js");
              }
            })();
          },
        ]);
    ...
    78311: (e, t, r) => {
      ...
      class s {
        ...
        parseRange(e) {
          const t = (this.options.includePrerelease && d) | (this.options.loose && g);
          const r = t + ":" + e;
          const n = a.get(r);
          if (n) {
            return n;
        ...
        intersects(e, t) {
          ...
          return this.set.some(
            (r) => R(r, t) && e.set.some((e) => R(e, t) && r.every((r) => e.every((e) => r.intersects(e, t)))),
          );
        }
        test(e) {
          if (!e) {
      ...
      const c = r(57272);
      const u = r(31527);
      const { safeRe: p, t: f, comparatorTrimReplace: h, tildeTrimReplace: E, caretTrimReplace: m } = r(99718);
      ...
      const C = (e, t) => {
        c("replaceGTE0", e, t);
        return e.trim().replace(p[t.includePrerelease ? f.GTE0PRE : f.GTE0], "");
      };
    ...
    46170: (e, t, r) => {
      ...
      const i = (e, t) => {
        ...
        if (!t.rtl) {
          ...
          let s;
          while ((s = n.exec(e)) && (!r || r.index + r[0].length !== e.length)) {
    ...
    16874: (e) => {
      ...
      const s = 16;
      const o = r - 6;
      const a = ["major", "premajor", "minor", "preminor", "patch", "prepatch", "prerelease"];
      e.exports = {
        MAX_LENGTH: r,
    ...
    99718: (e, t, r) => {
      const { MAX_SAFE_COMPONENT_LENGTH: n, MAX_SAFE_BUILD_LENGTH: s, MAX_LENGTH: o } = r(16874);
      const a = r(57272);
      t = e.exports = {};
      const i = (t.re = []);
      const l = (t.safeRe = []);
      ...
      m("COERCEPLAIN", `${"(^|[^\\d])" + "(\\d{1,"}${n}})` + `(?:\\.(\\d{1,${n}}))?` + `(?:\\.(\\d{1,${n}}))?`);
      ...
      m("COMPARATORTRIM", `(\\s*)${c[u.GTLT]}\\s*(${c[u.LOOSEPLAIN]}|${c[u.XRANGEPLAIN]})`, true);
    ...
    75032: (e, t, r) => {
      ...
      const p = (e, t, r) => {
        ...
        let E, m;
        let d, g;
        let v = l && !r.includePrerelease && l.semver.prerelease.length ? l.semver : false;
        let L = s && !r.includePrerelease && s.semver.prerelease.length ? s.semver : false;
        if (v && v.prerelease.length === 1 && l.operator === "<" && v.prerelease[0] === 0) {
          v = false;
        }
        for (const o of t) {
