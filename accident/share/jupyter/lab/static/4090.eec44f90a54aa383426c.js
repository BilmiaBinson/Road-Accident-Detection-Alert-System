        ...
        return l.CommonDiagonalStrike(function (t) {
          return function (r, i) {
            ...
            var p = r.adjustBorder(
              r.html(t, {
                style: { width: r.em(u), transform: "rotate(" + r.fixed(-e * c) + "rad) translateY(" + f + "em)" },
              }),
            );
            ...
            [
              function (t, e) {
                ...
                if (r.node.isKind("mtext")) {
                  ...
                  var o = n.append(
                    t.chtml,
                    t.html("mjx-tool", { style: { bottom: t.em(-t.dy), right: t.em(-t.dx) } }, [t.html("mjx-tip")]),
                  );
            ...
            "phasorangle",
            {
              renderer: function (t, e) {
                ...
                var c = t.adjustBorder(
                  t.html("mjx-ustrike", {
                    style: { width: t.em(s), transform: "translateX(" + t.em(h) + ") rotate(" + t.fixed(-a) + "rad)" },
                  }),
                );
    ...
    79901: function (t, e, r) {
      ...
      var l = (function (t) {
        ...
        e.prototype.makeAtop = function (t) {
          ...
          this.adaptor.append(
            this.chtml,
            this.html("mjx-frac", s, [(p = this.html("mjx-num", l)), (d = this.html("mjx-den", h))]),
          );
        ...
        e.prototype.handleColumnLines = function () {
          ...
          try {
            for (var a = n(this.childNodes), s = a.next(); !s.done; s = a.next()) {
              ...
              try {
                for (
                  var c = ((r = void 0), n(this.adaptor.childNodes(l.chtml).slice(1))), u = c.next();
                  !u.done;
                  u = c.next()
                ) {
                  var f = u.value;
    ...
    49821: function (t, e, r) {
      ...
      var u = (function (t) {
        ...
        e.prototype.toCHTML = function (e) {
          ...
          this.setDeltaW(
            [n, o, r],
            this.getDeltaW([s, l, a], [0, this.isLineBelow ? 0 : -u, this.isLineAbove ? 0 : u]),
          );
            ...
            this.testInline = this.html(
              ...
              [
                ...
                this.html("mjx-ex-box", {
                  style: { position: "absolute", overflow: "hidden", width: "1px", height: "60ex" },
                }),
      ...
      function c(t) {
        return (function (t) {
          ...
          e.prototype.getPadAlignShift = function (t) {
            ...
            var i = e + r;
            var o = n(
                this.styles == null ? ["", ""] : [this.styles.get("padding-left"), this.styles.get("padding-right")],
                2,
              ),
              a = o[0],
              s = o[1];
