...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [4462],
  {
    84462: (e, t, r) => {
      ...
      var m = ["in", "and", "or", "not", "is not", "is a", "is", "isn't", "defined", "if unless"],
        p = ["for", "if", "else", "unless", "from", "to"],
        f = ["null", "true", "false", "href", "title", "type", "not-allowed", "readonly", "disabled"],
        h = ["@font-face", "@keyframes", "@media", "@viewport", "@page", "@host", "@supports", "@block", "@css"];
      ...
      function Z(e, t) {
        ...
        if (R == "!") {
          e.next();
          return [e.match(/^(important|optional)/i) ? "keyword" : "operator", "important"];
        }
      ...
      function re(e, t) {
        return (oe(t) && (e == "{" || e == "]" || e == "hash" || e == "qualifier")) || e == "block-mixin";
      }
      function ie(e, t) {
      ...
      A.keyframes = function (e, t, r) {
        if (
          t.indentation() == "0" &&
          ((e == "}" && ne(t)) || e == "]" || e == "hash" || e == "qualifier" || M(t.current()))
        ) {
          return K(e, t, r);
        }
      ...
      A.interpolation = function (e, t, r) {
        ...
        if (e == "}") {
          if (t.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) || (t.string.match(/^\s*[a-z]/i) && M(le(t)))) {
            return G(r, t, "block");
          }
      ...
      A.variableName = function (e, t, r) {
        if (e == "string" || e == "[" || e == "]" || t.current().match(/^(\.|\$)/)) {
      ...
      const se = {
        name: "stylus",
        startState: function () {
          return { tokenize: null, state: "block", context: new I("block", 0, null) };
        },
        token: function (e, t) {
        ...
        indent: function (e, t, r) {
          ...
          if (
            i.prev &&
            ((a == "}" && (i.type == "block" || i.type == "atBlock" || i.type == "keyframes")) ||
