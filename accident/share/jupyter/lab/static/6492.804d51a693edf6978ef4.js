    ...
    46492: (e, t, a) => {
      ...
      function re(e, t) {
        ...
        if (a.name == ".") {
          ...
          return { from: t, quoted: null, parents: [], empty: true, aliases: i };
        }
      }
      const se = new Set(
      ...
      function oe(e, t) {
        ...
        for (let i = a.firstChild, r = false, s = null; i; i = i.nextSibling) {
          let t = i.name == "Keyword" ? e.sliceString(i.from, i.to).toLowerCase() : null;
          let a = null;
          if (!r) {
            r = t == "from";
      ...
      function le(e, t) {
        if (!e) return t;
        return t.map((t) =>
          Object.assign(Object.assign({}, t), { label: t.label[0] == e ? t.label : e + t.label + e, apply: undefined }),
        );
      }
      const ce = /^\w*$/,
        de = /^[`'"]?\w*[`'"]?$/;
      ...
      class me {
        ...
        addCompletions(e) {
          for (let t of e)
            this.addCompletion(typeof t == "string" ? pe(t, "property", this.idQuote, this.idCaseInsensitive) : t);
        }
        addNamespace(e) {
          if (Array.isArray(e)) {
        ...
        addNamespaceObject(e) {
          for (let t of Object.keys(e)) {
            let a = e[t],
              n = null;
            let i = t.replace(/\\?\./g, (e) => (e == "." ? "\0" : e)).split("\0");
            let r = this;
            if (ue(a)) {
              n = a.self;
              a = a.children;
      ...
      function pe(e, t, a, n) {
        if (new RegExp("^[a-z_][a-z_\\d]*$", n ? "i" : "").test(e)) return { label: e, type: t };
        return { label: e, type: t, apply: a + e + a };
      }
      function fe(e, t, a, n, i, r) {
        var s;
        let o =
          ((s = r === null || r === void 0 ? void 0 : r.spec.identifierQuotes) === null || s === void 0
            ? void 0
            : s[0]) || '"';
        let l = new me(o, !!(r === null || r === void 0 ? void 0 : r.spec.caseInsensitiveIdentifiers));
        ...
        return (e) => {
          let { parents: t, from: a, quoted: i, empty: r, aliases: s } = re(e.state, e.pos);
          ...
          return { from: a, to: d ? e.pos + 1 : undefined, options: le(i, u), validFor: i ? de : ce };
        };
      }
      function ge(e) {
      ...
      let be = J.configure({
        props: [
          ...
          n.foldNodeProp.add({
            Statement(e, t) {
              return { from: Math.min(e.from + 100, t.doc.lineAt(e.from).to), to: e.to };
            },
            BlockComment(e) {
      ...
      function ke(e) {
        return e.schema
          ? fe(e.schema, e.tables, e.schemas, e.defaultTable, e.defaultSchema, e.dialect || we)
          : () => null;
      }
      function xe(e) {
        return e.schema ? (e.dialect || we).language.data.of({ autocomplete: ke(e) }) : [];
      }
      function Oe(e = {}) {
        let t = e.dialect || we;
        return new n.LanguageSupport(t.language, [
          xe(e),
          t.language.data.of({ autocomplete: ye(t, e.upperCaseKeywords, e.keywordCompletion) }),
        ]);
      }
      const we = _e.define({});
      const Qe = _e.define({
      ...
      const Te = _e.define({
        ...
        specialVar: "@?",
        identifierQuotes: "`",
        keywords: M + "always generated groupby_concat hard persistent shutdown soft virtual " + Ce,
        types: Se,
        builtin: qe,
      });
      const Ue = _e.define({
