  ...
  [8313],
  {
    48313: (t, e, n) => {
      ...
      class C {
        ...
        work(t, e) {
          ...
          return this.withContext(() => {
            ...
            if (e != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > e) && e < this.state.doc.length)
              this.parse.stopAt(e);
            for (;;) {
              let i = this.parse.advance();
              if (i) {
                this.fragments = this.withoutTempSkipped(
                  r.TreeFragment.addTree(i, this.fragments, this.parse.stoppedAt != null),
                );
                this.treeLen = (n = this.parse.stoppedAt) !== null && n !== void 0 ? n : this.state.doc.length;
                this.tree = i;
                this.parse = null;
                if (this.treeLen < (e !== null && e !== void 0 ? e : this.state.doc.length))
      ...
      const O =
        ...
        ((d = navigator.scheduling) === null || d === void 0 ? void 0 : d.isInputPending)
      ...
      function H(t, e, n) {
        ...
        let i = e.resolveInner(n, -1).resolve(n, 0).enterUnfinishedNodesBefore(n);
        if (i != r.node) {
          let t = [];
          for (let e = i; e && !(e.from == r.node.from && e.type == r.node.type); e = e.parent) t.push(e);
      ...
      function Ut(t, e) {
        ...
        if (e === null || e === void 0 ? void 0 : e.fallback) n.push(jt.of(t));
          ...
          n.push(
            Vt.computeN([a.EditorView.darkTheme], (e) => (e.facet(a.EditorView.darkTheme) == (r == "dark") ? [t] : [])),
          );
        else n.push(Vt.of(t));
        return n;
      }
        ...
        update(t, e) {
          ...
          for (let i of e.state.selection.ranges) {
            ...
            let t =
              ...
              (r.afterCursor &&
                (se(e.state, i.head, 1, r) || (i.head < e.state.doc.length && se(e.state, i.head + 1, -1, r))));
      ...
      class de extends k {
        ...
        getIndent(t) {
          ...
          let r = pe(this, t.node.tree, t.node.from, t.node.from, e !== null && e !== void 0 ? e : t.pos),
            i,
            s;
          if (r) {
            s = r.state;
          ...
          while (i < t.pos) {
            ...
            if (e.length) {
              let i = n ? n(e.from) : -1;
              let o = new fe(e.text, t.state.tabSize, t.unit, i < 0 ? undefined : i);
      ...
      function ge(t, e, n, i, s) {
        ...
        for (let o = e.children.length - 1; o >= 0; o--) {
          ...
          if (a < i && l instanceof r.Tree) {
            ...
            return !s
              ? f
              : new r.Tree(e.type, e.children.slice(0, o).concat(f), e.positions.slice(0, o + 1), a + f.length);
          }
        }
        return null;
      }
      function me(t, e, n, i, s) {
        for (let r of e) {
          ...
          let o = e <= n && s > n && pe(t, r.tree, 0 - r.offset, n, s),
            a;
          if (o && o.pos <= i && (a = ge(t, r.tree, n + r.offset, o.pos + r.offset, false)))
            return { state: o.state, tree: a };
        }
        return { state: t.streamParser.startState(s ? V(s) : 4), tree: r.Tree.empty };
      }
      class ke {
        constructor(t, e, n, r) {
          this.lang = t;
          ...
          let i = C.get(),
            s = r[0].from;
          let { state: o, tree: a } = me(t, n, s, this.to, i === null || i === void 0 ? void 0 : i.state);
          this.state = o;
        ...
        emitToken(t, e, n, r) {
          ...
          if (this.lang.streamParser.mergeTokens && i == 4 && s >= 0 && this.chunk[s] == t && this.chunk[s + 2] == e)
            this.chunk[s + 2] = n;
      ...
      const Me = a.ViewPlugin.fromClass(
        ...
        },
        {
          provide: (t) => {
            function e(e) {
              var n, r;
              return (r = (n = e.plugin(t)) === null || n === void 0 ? void 0 : n.decorations) !== null && r !== void 0
                ? r
                : a.Decoration.none;
            }
