                ...
                (t.FitAddon = class {
                  ...
                  proposeDimensions() {
                    ...
                    const r = 0 === this._terminal.options.scrollback ? 0 : e.viewport.scrollBarWidth,
                      ...
                      l =
                        s -
                        (parseInt(a.getPropertyValue("padding-top")) + parseInt(a.getPropertyValue("padding-bottom"))),
                      o =
                        n -
                        (parseInt(a.getPropertyValue("padding-right")) + parseInt(a.getPropertyValue("padding-left"))) -
                        r;
                    return {
