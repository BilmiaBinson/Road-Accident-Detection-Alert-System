  ...
  [6003],
  {
    56003: (t, e, n) => {
      ...
      (() => {
        ...
        for (let e = 0, n = 0; e < t.length; e++) (e % 2 ? s : i).push((n = n + t[e]));
      })();
      function r(t) {
      ...
      class w extends m {
        ...
        decompose(t, e, n, i) {
          let s =
            t <= 0 && e >= this.length ? this : new w(y(this.text, t, e), Math.min(e, this.length) - Math.max(0, t));
          if (i & 1) {
            let t = n.pop();
        ...
        static from(t, e = t.reduce((t, e) => t + e.length + 1, -1)) {
          ...
          function f(t) {
            ...
            if (t.lines > s && t instanceof x) {
              ...
              c();
              l.push(t);
            } else if (t instanceof w && h && (e = a[a.length - 1]) instanceof w && t.lines + e.lines <= 32) {
              h += t.lines;
              o += t.length + 1;
              a[a.length - 1] = new w(e.text.concat(t.text), e.length + 1 + t.length);
            } else {
              if (h + t.lines > i) c();
              h += t.lines;
              o += t.length + 1;
      ...
      class S {
        constructor(t, e = 1) {
          ...
          this.value = "";
          this.nodes = [t];
          this.offsets = [e > 0 ? 1 : (t instanceof w ? t.text.length : t.children.length) << 1];
        }
        nextInner(t, e) {
          ...
          for (;;) {
            ...
            if (r == (e > 0 ? l : 0)) {
              ...
              if (t > s.length) {
                ...
                this.nodes.push(s);
                this.offsets.push(e > 0 ? 1 : (s instanceof w ? s.text.length : s.children.length) << 1);
              }
            }
          }
        }
          ...
          for (let r = 0; r < this.sections.length; ) {
            ...
            if (h < 0) {
              ...
              if (
                n != B.Simple &&
                o >= t &&
                ((n == B.TrackDel && i < t && o > t) || (n == B.TrackBefore && i < t) || (n == B.TrackAfter && o > t))
              )
                return null;
      ...
      class D extends N {
        ...
        static of(t, e, n) {
          ...
          function o(t) {
            if (Array.isArray(t)) {
              ...
              if (l > o || l < 0 || o > e)
                throw new RangeError(`Invalid change range ${l} to ${o} (in doc of length ${e})`);
              let f = !a ? m.empty : typeof a == "string" ? m.of(a.split(n || F)) : a;
              let c = f.length;
              if (l == o && c == 0) return;
              if (l < r) h();
              if (l > r) J(i, l - r, -1);
        ...
        static fromJSON(t) {
          ...
          for (let i = 0; i < t.length; i++) {
            ...
            if (typeof s == "number") {
              e.push(s, -1);
            } else if (!Array.isArray(s) || typeof s[0] != "number" || s.some((t, e) => e && typeof t != "string")) {
      ...
      function q(t, e, n, i = false) {
        ...
        for (let o = -1; ; ) {
          if ((l.done && h.len) || (h.done && l.len)) {
            ...
            h.ins >= 0 &&
            (l.ins < 0 || o == l.i || (l.off == 0 && (h.len < l.len || (h.len == l.len && !n))))
          ) {
            let t = h.len;
            J(s, h.ins, -1);
            while (t) {
      ...
      class _ {
        ...
        textBit(t) {
          let { inserted: e } = this.set,
            n = (this.i - 2) >> 1;
          return n >= e.length && !t ? m.empty : e[n].slice(this.off, t == null ? undefined : this.off + t);
        }
        forward(t) {
      ...
      class z {
        ...
        map(t, e = -1) {
          ...
          return n == this.from && i == this.to ? this : new z(n, i, this.flags);
        }
        extend(t, e = t) {
      ...
      class V {
        ...
        static create(t, e = 0) {
          ...
          for (let n = 0, i = 0; i < t.length; i++) {
            let s = t[i];
            if (s.empty ? s.from <= n : s.from < n) return V.normalized(t.slice(), e);
            n = s.to;
          }
          return new V(t, e);
        }
        ...
        static range(t, e, n, i) {
          ...
          return e < t ? z.create(e, t, 32 | 16 | s) : z.create(t, e, (e > t ? 8 : 0) | s);
        }
        static normalized(t, e = 0) {
          ...
          for (let i = 1; i < t.length; i++) {
            ...
            if (n.empty ? n.from <= s.to : n.from < s.to) {
              ...
              if (i <= e) e--;
              t.splice(--i, 2, n.anchor > n.head ? V.range(l, r) : V.range(r, l));
            }
          }
          return new V(t, e);
        }
      ...
      class K {
        ...
        dynamicSlot(t) {
          ...
          return {
            ...
            update(t, e) {
              if ((h && e.docChanged) || (o && (e.docChanged || e.selection)) || X(t, a)) {
                let e = n(t);
      ...
      class tt {
        ...
        static define(t) {
          let e = new tt(U++, t.create, t.update, t.compare || ((t, e) => t === e), t);
          ...
          return {
            ...
            reconfigure: (t, n) => {
              let i = t.facet(Z),
                s = n.facet(Z),
                r;
              if ((r = i.find((t) => t.field == this)) && r != s.find((t) => t.field == this)) {
      ...
      const dt = G.define({ combine: (t) => (t.length ? t[0] : undefined), static: true });
      const gt = G.define();
      const pt = G.define();
      const mt = G.define();
      ...
      class yt {
        ...
        map(t) {
          ...
          return e === undefined ? undefined : e == this.value ? this : new yt(this.type, e);
        }
        is(t) {
          return this.type == t;
        }
      ...
      class St {
        constructor(t, e, n, i, s, r) {
          ...
          if (!s.some((t) => t.type == St.time)) this.annotations = s.concat(St.time.of(Date.now()));
        }
      ...
      function It(t, e, n) {
        ...
        return {
          ...
          effects: yt.mapEffects(t.effects, s).concat(yt.mapEffects(e.effects, r)),
      ...
      function Pt(t, e, n) {
        ...
        return {
          changes: e.changes instanceof D ? e.changes : D.of(e.changes || [], n, t.facet(dt)),
      ...
      function Et(t, e, n) {
        ...
        let s = St.create(t, i.changes, i.selection, i.effects, i.annotations, i.scrollIntoView);
        return At(n ? Mt(s) : s);
      }
      function Mt(t) {
        let e = t.startState;
        ...
        for (let s = i.length - 1; s >= 0; s--) {
          ...
          else if (Array.isArray(n) && n.length == 1 && n[0] instanceof St) t = n[0];
      ...
      function At(t) {
        ...
        for (let s = n.length - 1; s >= 0; s--) {
          let r = n[s](t);
          if (r && Object.keys(r).length) i = It(i, Pt(e, r, t.changes.newLength), true);
        }
        return i == t ? t : St.create(e, t.changes, t.selection, i.effects, i.annotations, i.scrollIntoView);
      }
      const Ct = [];
      function Rt(t) {
      ...
      function Bt(t) {
        ...
        for (let e = 0; e < t.length; e++) {
          let n = t[e];
          if (/\w/.test(n) || (n > "" && (n.toUpperCase() != n.toLowerCase() || Tt.test(n)))) return true;
        }
        return false;
      }
      function Nt(t) {
        return (e) => {
          ...
          for (let n = 0; n < t.length; n++) if (e.indexOf(t[n]) > -1) return Ot.Word;
          return Ot.Other;
        };
      }
      class Dt {
        constructor(t, e, n, i, s, r) {
          ...
          this.computeSlot = s;
          if (r) r._state = this;
          for (let l = 0; l < this.config.dynamicSlots.length; l++) at(this, l << 1);
        ...
        applyTransaction(t) {
          ...
          let r = t.startState.facet(ut) ? t.newSelection : t.newSelection.asSingle();
        ...
        changeByRange(t) {
          ...
          return { changes: i, selection: V.create(s, e.mainIndex), effects: r };
        }
        changes(t = []) {
        ...
        toJSON(t) {
          ...
          if (t)
            for (let n in t) {
              let i = t[n];
              if (i instanceof tt && this.config.address[i.id] != null) e[n] = i.spec.toJSON(this.field(t[n]), this);
            }
          return e;
        }
        ...
        static create(t = {}) {
          ...
          let n = t.doc instanceof m ? t.doc : m.of((t.doc || "").split(e.staticFacet(Dt.lineSeparator) || F));
          let i = !t.selection
            ? V.single(0)
      ...
      class _t {
        ...
        update(t) {
          ...
          while (l.value || h < e.length) {
            if (h < e.length && (l.from - e[h].from || l.startSide - e[h].value.startSide) >= 0) {
              ...
              if (!r || i > l.to || s < l.from || r(l.from, l.to, l.value)) {
                if (!a.addInner(l.from, l.to, l.value)) o.push(jt.create(l.from, l.to, l.value));
              }
              l.next();
            }
          }
          return a.finishInner(
            this.nextLayer.isEmpty && !o.length
              ? _t.empty
              : this.nextLayer.update({ add: o, filter: r, filterFrom: i, filterTo: s }),
          );
        }
        map(t) {
        ...
        static eq(t, e, n = 0, i) {
          ...
          for (;;) {
            if (h.to != o.to || !Xt(h.active, o.active) || (h.point && (!o.point || !h.point.eq(o.point))))
              return false;
        ...
        static of(t, e = false) {
          let n = new Vt();
          for (let i of t instanceof jt ? [t] : e ? zt(t) : t) n.add(i.from, i.to, i.value);
          return n.finish();
        }
        static join(t) {
          ...
          for (let n = t.length - 2; n >= 0; n--) {
            for (let i = t[n]; i != _t.empty; i = i.nextLayer)
              e = new _t(i.chunkPos, i.chunk, e, Math.max(i.maxPoint, e.maxPoint));
          }
          return e;
        }
      }
      ...
      class Vt {
        ...
        add(t, e, n) {
          if (!this.addInner(t, e, n)) (this.nextLayer || (this.nextLayer = new Vt())).add(t, e, n);
        }
        addInner(t, e, n) {
      ...
      function Wt(t, e, n) {
        let i = new Map();
        for (let r of t)
          for (let t = 0; t < r.chunk.length; t++) if (r.chunk[t].maxPoint <= 0) i.set(r.chunk[t], r.chunkPos[t]);
        let s = new Set();
        for (let r of e)
      ...
      class Kt {
        ...
        forward(t, e) {
          while (
            this.minActive > -1 &&
            (this.activeTo[this.minActive] - t || this.active[this.minActive].endSide - e) < 0
          )
        ...
        activeForPoint(t) {
          ...
          for (let n = this.active.length - 1; n >= 0; n--) {
            ...
            if (this.activeTo[n] > t || (this.activeTo[n] == t && this.active[n].endSide >= this.point.endSide))
      ...
      function Qt(t, e, n, i, s, r) {
        ...
        for (;;) {
          ...
          if (t.point || n.point) {
            ...
            if (a > h && !Xt(t.active, n.active)) r.compareRange(h, a, t.active, n.active);
          }
          if (s > l) break;
