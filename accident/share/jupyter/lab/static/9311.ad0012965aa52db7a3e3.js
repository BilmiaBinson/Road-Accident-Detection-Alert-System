  ...
  [9311],
  {
    79311: (e, t, n) => {
      ...
      class h {
        ...
        addChild(e, t) {
          if (e.prop(o.NodeProp.contextHash) != this.hash)
            e = new o.Tree(e.type, e.children, e.positions, e.length, this.hashProp);
      ...
      function d(e, t, n) {
        ...
        return r > 0 && (e.type != f.BulletList || b(n, t, false) < 0) && n.text.charCodeAt(n.pos + r - 1) == e.value;
      }
      const p = {
        [f.Blockquote](e, t, n) {
      ...
      const v = {
        ...
        ATXHeading(e, t) {
          ...
          let o = e.buffer
            ...
            .writeElements(e.parser.parseInline(t.text.slice(r + n + 1, l), s + n + 1), -s);
      ...
      class N {
        ...
        finish(e, t) {
          if ((this.stage == 2 || this.stage == 3) && m(t.content, this.pos) == t.content.length)
      ...
      class R {
        nextLine(e, t, n) {
          ...
          e.addLeafElement(
            n,
            J(s == 61 ? f.SetextHeading1 : f.SetextHeading2, n.start, e.prevLineEnd(), [
      ...
      class $ {
        ...
        addLeafElement(e, t) {
          this.addNode(
            this.buffer.writeElements(ue(t.children, e.marks), -t.from).finish(t.type, t.to - t.from),
            t.from,
          );
        }
        finishContext() {
        ...
        addGaps(e) {
          return this.ranges.length > 1 ? _(this.ranges, 0, e.topNode, this.ranges[0].from, this.reusePlaceholders) : e;
        }
        finishLeaf(e) {
      ...
      for (let Lt = 1, bt; (bt = f[Lt]); Lt++) {
        Q[Lt] = o.NodeType.define({
          ...
          name: bt,
          props:
            Lt >= f.Escape ? [] : [[o.NodeProp.group, Lt in p ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
          top: bt == "Document",
        });
      }
      const Z = [];
      ...
      class G {
        ...
        toTree(e) {
          return new V(e).writeElements(this.children, -this.from).finish(this.type, this.to - this.from);
        }
      }
      class K {
        constructor(e, t) {
      ...
      function ue(e, t) {
        ...
        for (let s of t) {
          ...
          if (r < n.length && n[r].from < s.from) {
            let e = n[r];
            if (e instanceof G) n[r] = new G(e.type, e.from, e.to, ue(e.children, [s]));
          } else {
            n.splice(r++, 0, s);
          }
        }
        ...
        parseInline: [
          {
            ...
            parse(e, t, n) {
              ...
              let o = se.test(r),
                a = se.test(s);
              return e.addDelimiter(Le, n, n + 2, !l && (!a || i || o), !i && (!o || l || a));
            },
            after: "Emphasis",
          },
        ],
      ...
      const De = {
        ...
        parseInline: [{ name: "Superscript", parse: ze(94, "Superscript", "SuperscriptMark") }],
      };
      const $e = {
        defineNodes: [
        ...
        parseInline: [{ name: "Subscript", parse: ze(126, "Subscript", "SubscriptMark") }],
      };
      const _e = {
      ...
      const We = Ue.configure([
        ...
        De,
        _e,
        { props: [i.foldNodeProp.add({ Table: (e, t) => ({ from: t.doc.lineAt(e.from).to, to: e.to }) })] },
      ]);
      const Ye = Ke(We);
      function et(e, t) {
        return (n) => {
          if (n && e) {
            ...
            if (t instanceof i.LanguageDescription)
              return t.support ? t.support.language.parser : i.ParseContext.getSkippingParser(t.load());
      ...
      class tt {
        ...
        marker(e, t) {
          let n = this.node.name == "OrderedList" ? String(+rt(this.item, e)[2] + t) : "";
      ...
      function nt(e, t) {
        ...
        for (let s = n.length - 1; s >= 0; s--) {
          ...
          let l = t.lineAt(e.from),
            o = e.from - l.from;
          if (e.name == "Blockquote" && (i = /^ *>( ?)/.exec(l.text.slice(o)))) {
      ...
      const lt = ({ state: e, dispatch: t }) => {
        ...
        let l = null,
          o = e.changeByRange((t) => {
            if (!t.empty || !Ye.isActiveAt(e, t.from, 0)) return (l = { range: t });
            let i = t.from,
              o = s.lineAt(i);
            ...
            if (!c || /^[\s\d.)\-+*>]*/.exec(o.text)[0].length >= h.to) {
              for (let e = 0, t = a.length - 1; e <= t; e++) {
                d +=
                  e == t && !c
                    ? a[e].marker(s, 1)
                    : a[e].blank(e < t ? (0, r.countColumn)(o.text, 4, a[e + 1].from) - d.length : null);
              }
            }
            let p = i;
      ...
      function ht(e, t, n) {
        ...
        for (let i = 0, l = e.length - 2; i <= l; i++) {
          s += e[i].blank(
            i < l ? (0, r.countColumn)(n.text, 4, Math.min(n.text.length, e[i + 1].from)) - s.length : null,
            i < l,
          );
        }
        return it(s, t);
      ...
      function pt(e = {}) {
        ...
        if (!(o instanceof F)) throw new RangeError("Base parser provided to `markdown` should be a Markdown parser");
      ...
      function gt(e) {
        ...
        return { from: n - r[0].length, to: n, options: kt(), validFor: /^<[:\-\.\w\u00b7-\uffff]*$/ };
      }
      let mt = null;
      function kt() {
        if (mt) return mt;
        let e = (0, Fe.htmlCompletionSource)(new l._5(r.EditorState.create({ extensions: dt }), 0, true));
