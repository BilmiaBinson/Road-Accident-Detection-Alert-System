  ...
  [2707],
  {
    ...
    94650: function (e, t, r) {
      ...
      var k = (function (e) {
        ...
        t.prototype.checkItem = function (e) {
          ...
          if (
            e.isKind("mml") &&
            (p.default.isType(e.First, "mo") || p.default.isType(e.First, "mi") || p.default.isType(e.First, "mtext"))
          ) {
            t = e.First;
    ...
    38364: function (e, t, r) {
      ...
      A.MathFont = function (e, t, r) {
        ...
        var i = new p.default(
          n,
          a(a({}, e.stack.env), { font: r, multiLetterIdentifiers: /^[a-zA-Z]+/, noAutoOP: true }),
          e.configuration,
        ).mml();
      ...
      A.NamedOp = function (e, t, r) {
        ...
        var a = e.create(
          "token",
          "mo",
          { movablelimits: true, movesupsub: true, form: h.TexConstant.Form.PREFIX, texClass: m.TEXCLASS.OP },
          r,
        );
        e.Push(a);
      };
        ...
        if (r) {
          n = [
            e.create("node", "mpadded", n, {
              width: r,
              "data-align": (0, b.lookup)(a, { l: "left", r: "right" }, "center"),
            }),
          ];
        }
        var i = e.create("node", "TeXAtom", [e.create("node", "menclose", n, { notation: "box" })], {
