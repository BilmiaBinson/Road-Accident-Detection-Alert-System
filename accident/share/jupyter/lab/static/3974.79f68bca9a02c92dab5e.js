  ...
  [3974],
  {
    93974: (e, t, n) => {
      ...
      function h(e, t) {
        ...
        if (r === "comment" && t.lastToken === "(") return (t.tokenize = y)(e, t);
      ...
      const g = {
        name: "clojure",
        startState: function () {
          return { ctx: { prev: null, start: 0, indentTo: 0 }, lastToken: null, tokenize: h };
        },
        token: function (e, t) {
          ...
          if (r !== "space") {
            if (t.lastToken === "(" && t.ctx.indentTo === null) {
              if (r === "symbol" && k(s, l)) t.ctx.indentTo = t.ctx.start + e.indentUnit;
          ...
          if (r === "open") t.ctx = { prev: t.ctx, start: e.column(), indentTo: null };
