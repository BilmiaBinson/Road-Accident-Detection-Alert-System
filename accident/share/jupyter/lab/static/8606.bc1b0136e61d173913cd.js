...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [8606],
  {
      ...
      s.prototype = r.prototype = {
        ...
        call: function (t, n) {
          if ((r = arguments.length - 2) > 0)
            for (var e = new Array(r), i = 0, r, s; i < r; ++i) e[i] = arguments[i + 2];
    ...
    25216: (t, n, e) => {
      ...
      function g(t) {
        var n =
            t.grouping === undefined || t.thousands === undefined ? _ : r(p.call(t.grouping, Number), t.thousands + ""),
    ...
    26698: (t, n, e) => {
      ...
      function h(t, n, e, h) {
        ...
        switch (h.type) {
          ...
          case "p":
          case "r": {
            if (h.precision == null && !isNaN((l = (0, o.A)(c, Math.max(Math.abs(t), Math.abs(n))))))
    ...
    74725: (t, n, e) => {
      ...
      function d(t, n, e, i, r, s, a, o, u, h) {
        ...
        function k(t) {
          return (
            u(t) < t ? v : o(t) < t ? x : a(t) < t ? w : s(t) < t ? m : i(t) < t ? (r(t) < t ? b : A) : e(t) < t ? M : T
          )(t);
        }
        c.invert = function (t) {
          return new Date(l(t));
              ...
              if (c < r.pi) {
                if ((X = l(E, R, j, z, q, L, H, Y))) {
                  var I = E - X[0],
                    ...
                    Z =
                      1 /
                      (0, r.F8)((0, r.HQ)((I * G + O * J) / ((0, r.RZ)(I * I + O * O) * (0, r.RZ)(G * G + J * J))) / 2),
