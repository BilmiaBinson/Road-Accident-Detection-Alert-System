            ...
            [
              this.adaptor.node(
                "span",
                {
                  ...
                  title: e.message,
                  style: { color: "red", "background-color": "yellow", "line-height": "normal" },
                },
      ...
      var h = (function (t) {
        ...
        e.prototype.findMath = function (t) {
          ...
          if (!this.processed.isSet("findMath")) {
            ...
            try {
              for (
                var h = a(this.adaptor.getElements(t["elements"], this.document)), d = h.next();
                !d.done;
                d = h.next()
              ) {
                var y = d.value;
              ...
              try {
                ...
                switch (a[0]) {
                  ...
                  case 7:
                    ...
                    continue;
                  default:
                    if (!((o = r.tries), (o = o.length > 0 && o[o.length - 1])) && (a[0] === 6 || a[0] === 2)) {
                      r = 0;
                      continue;
                    }
