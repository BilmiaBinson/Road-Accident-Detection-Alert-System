  ...
  [1268],
  {
    91268: (e, t, s) => {
      ...
      class R extends $ {
        ...
        walk(e) {
          let t = C(this.exprs, e);
          return e(t == this.exprs ? this : new R(this.start, t, this.markers, this.empty && !t.length));
        }
      }
      R.prototype.prec = 2;
      class P extends a {
      ...
      class L {
        ...
        finish(e) {
          ...
          this.terms = this.terms.filter(
            (t) => t.terminal || t.preserve || e.some((e) => e.name == t || e.parts.includes(t)),
          );
          let t = {};
          let s = [this.error];
          this.error.id = 0;
      ...
      class Y {
        ...
        cmp(e) {
          return (
            ...
            W(this.ambigGroups, e.ambigGroups, (e, t) => (e < t ? -1 : e > t ? 1 : 0)) ||
            this.cut - e.cut
          );
        }
      }
        ...
        closure() {
          ...
          function s(i) {
            ...
            if (
              ...
              (i.accepting.length > 0 && !i.edges.some((e) => ue(i.accepting, e.target.accepting)))
            )
              e.push(i);
        ...
        findConflicts(e) {
          ...
          this.reachable((t, n) => {
            ...
            for (let e = 0; e < t.accepting.length; e++)
              for (let s = e + 1; s < t.accepting.length; s++) i(t.accepting[e], t.accepting[s], 0, n);
            t.reachable((r, l) => {
              if (r != t)
                for (let a of r.accepting) {
                  let r = s.includes(a);
                  for (let o of t.accepting)
                    if (a != o) i(a, o, r || s.includes(o) || !e(a, o) ? 0 : 1, n, n.concat(l));
                }
            });
          });
          return t;
      ...
      function Re(e) {
        ...
        if (n)
          e.raise("Empty expression in choice operator. If this is intentional, use () to make it explicit.", n.start);
        return new O(t, i);
      }
      function Pe(e) {
      ...
      function je(e) {
        ...
        while (!e.eat("}")) {
          ...
          s.push({
            id: Pe(e),
            type: e.eat("at", "left") ? "left" : e.eat("at", "right") ? "right" : e.eat("at", "cut") ? "cut" : null,
          });
        }
        return new h(t, s);
      }
      ...
      class Le {
        ...
        conflicts(e = this.pos) {
          ...
          if (e == this.rule.parts.length && this.ambigAhead.length) t = t.join(new Y(0, this.ambigAhead));
          return t;
        }
      ...
      class Ve {
        ...
        eq(e) {
          return e instanceof Ve && this.term == e.term && e.target.id == this.target.id;
        }
        cmp(e) {
      ...
      class st {
        ...
        toString() {
          let e =
            ...
            (this.goto.length ? " | " + this.goto.map((e) => e.term + "=" + e).join(",") : "");
          return (
            this.id +
            ": " +
        ...
        addAction(e, t, s) {
          ...
          if (i) {
            ...
            let l;
            if (i instanceof Ve) l = `shift/reduce conflict between\n  ${n}\nand\n  ${t[0].rule}`;
      ...
      function it(e, t) {
        ...
        while (i.length) {
          ...
          n(
            ...
            Z(e.rule.conflicts[1].ambigGroups, e.rule.parts.length == 1 ? e.ambigAhead : xt),
        ...
        function a(e, t) {
          ...
          if (!p) {
            ...
            if (Me && i.length % 500 == 0)
              console.log(`${i.length} states after ${((Date.now() - l) / 1e3).toFixed(2)}s`);
          }
        ...
        for (let u = 0; u < i.length; u++) {
          ...
          if (l)
            for (let i = 0; i < e.goto.length; i++) {
              ...
              if (!t.some((t) => e.actions.some((e) => e.term == t && e instanceof Ve))) e.goto.splice(i--, 1);
            }
        }
      ...
      function kt(e) {
        for (let t = 1; ; t++) {
          ...
          if (Me)
            console.log(`Merge identical pass ${t}${i ? "" : ", done"} (${((Date.now() - n) / 1e3).toFixed(2)}s)`);
          if (!i) return e;
          for (let e of r)
            if (!e.defaultReduce) {
      ...
      class Rt {
        constructor(e, t) {
          ...
          for (let n in s) {
            if (s[n] instanceof i.NodeProp && !s[n].perNode)
              this.knownProps[n] = { prop: s[n], source: { name: n, from: null } };
          }
          ...
          Fe("Build rules", () => {
            ...
            for (let { skip: n, rule: r } of this.astRules) {
              if (this.ruleNames[r.id.name] && ps(r) && !r.params.length) {
                ...
                if (r.expr instanceof R && r.expr.exprs.length == 0) this.used(r.id.name);
              }
            }
          });
        ...
        prepareParser() {
          ...
          for (let R in this.namedTerms) this.termTable[R] = this.namedTerms[R].id;
          ...
          let {
            ...
            tokenPrec: f,
            tokenData: c,
          } = Fe("Build token groups", () => this.tokens.buildTokenGroups(o, a, u.length));
          ...
          for (let R in this.specialized) m.push({ token: this.terms.names[R], table: At(this.specialized[R]) });
          let g = (e) => {
          ...
          for (let R = 0; R < this.dialects.length; R++)
            y[this.dialects[R]] = x.storeArray((this.tokens.byDialect[R] || vt).map((e) => e.id).concat(65535));
          let $ = null;
          ...
          for (let R of this.terms.tops) v[R.nodeName] = [p.find((e) => e.startRule == R).id, R.id];
        ...
        getParserFile() {
          ...
          let R = this.ast.context ? S(this.ast.context.id.name, this.ast.context.source) : null;
          ...
          for (let G = 0; G < this.dialects.length; G++)
            D.push(`Dialect_${this.dialects[G]}${g == "cjs" ? ":" : " ="} ${G}`);
          return {
        ...
        computeForceReductions(e, t) {
          ...
          for (let a of e) {
            ...
            i[a.id] = a.set
              ...
              .sort((e, t) => t.pos - e.pos || e.rule.parts.length - t.rule.parts.length);
          }
          ...
          for (let i of e) {
            if (i.type == "ambig") {
              ...
              if (r.type == "cut") {
                ...
                t = t.join(new Y(l << 2));
                s = s.join(new Y((l << 2) + (r.type == "left" ? 1 : r.type == "right" ? -1 : 0)));
              }
            }
          }
        ...
        defineRule(e, t) {
          ...
          for (let i of t) this.rules.push(new Q(e, i.terms, i.ensureConflicts(), s));
        }
        resolve(e) {
        ...
        nodeInfo(e, t, s = null, i = vt, n = vt, r, l) {
          ...
          for (let d of e) {
            if (!d.at) {
              if (!this.knownProps[d.name]) {
                let e = ["name", "dialect", "dynamicPrecedence", "export", "isGroup"].includes(d.name)
                  ? ` (did you mean '@${d.name}'?)`
                  : "";
          ...
          if (f && (U(a) || u || h))
            this.raise(`Inline nodes can't have props, dynamic precedence, or a dialect`, e[0].start);
          if (f && o) o = null;
        ...
        finishProp(e, t, s) {
          return e.value
            .map((e) => {
              ...
              if (i < 0)
                this.raise(`Property refers to '${e.name}', but no parameter by that name is in scope`, e.start);
              let n = t[i];
        ...
        resolveSpecialization(e) {
          ...
          else if (e.content instanceof O && e.content.exprs.every((e) => e instanceof N))
          ...
          for (let f of a) {
            ...
            if (l == null) {
              ...
              if (l.dialect != n)
                this.raise(`Conflicting dialects for specialization ${JSON.stringify(f)} of ${o.name}`, e.start);
              if (l.name != s)
                this.raise(`Conflicting names for specialization ${JSON.stringify(f)} of ${o.name}`, e.start);
              if (u && l.term != u)
                this.raise(`Conflicting specialization tokens for ${JSON.stringify(f)} of ${o.name}`, e.start);
              u = l.term;
            }
          }
          return u;
        ...
        defineGroup(e, t, s) {
          ...
          for (let l of r(e))
            l.props["group"] = (((i = l.props["group"]) === null || i === void 0 ? void 0 : i.split(" ")) || [])
              .concat(t)
              .sort()
              .join(" ");
        }
          ...
          for (let i = 0; i < s.length; i++) {
            ...
            for (let t = i + 1; t < s.length; t++) {
              ...
              if (
                ...
                (r.length > i.length ? i.some((e) => !r.includes(e)) : r.some((e) => !i.includes(e)))
              )
      ...
      class jt {
        ...
        findSharedActions(e) {
          ...
          for (let r of this.sharedActions) {
            if ((!t || r.actions.length > t.actions.length) && r.actions.every((t) => e.actions.some((e) => e.eq(t))))
              t = r;
          }
          if (t) return t;
          let s = null,
      ...
      class Mt extends Ut {
        ...
        buildTokenGroups(e, t, s) {
          ...
          let n = i
            ...
            .filter(({ a: e, b: t }) => !this.precededBy(e, t) && !this.precededBy(t, e));
          ...
          for (let h of e) {
            ...
            for (let t of n)
              if (h.actions.some((e) => e.term == t)) this.b.raise(`Use of token ${t.name} conflicts with skip rule`);
            let r = [];
          ...
          if (o.length + s > 16)
            this.b.raise(`Too many different token groups (${o.length}) to represent them as a 16-bit bitfield`);
      ...
      class Ft extends Ut {
        ...
        buildLocalGroup(e, t, s) {
          ...
          return {
            groupID: s,
            create: () => new r.uC(o, a, this.fallback ? this.fallback.id : undefined),
            createSource: (e) =>
