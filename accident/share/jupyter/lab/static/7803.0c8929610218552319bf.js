    ...
    57803: (t, e, a) => {
      ...
      class l {
        ...
        static get(t, e) {
          ...
          let n = h(e);
          for (let o of t.set) if (!o.modified.length) for (let t of n) i.push(l.get(o, t));
          return r;
        }
      }
      function c(t, e) {
      ...
      class b {
        ...
        highlightRange(t, e, a, r, n) {
          ...
          if (s >= a || l <= e) return;
          if (o.isTop) n = this.highlighters.filter((t) => !t.scope || t.scope(o));
          let c = r;
          let h = y(t) || d.empty;
          let f = m(n, h.tags);
          if (f) {
          ...
          if (g && g.overlay) {
            ...
            let o = this.highlighters.filter((t) => !t.scope || t.scope(g.tree.type));
            let h = t.firstChild();
            for (let f = 0, d = s; ; f++) {
              ...
              d = p.to + s;
              if (d > e) {
                this.highlightRange(i.cursor(), Math.max(e, p.from + s), Math.min(a, d), "", o);
