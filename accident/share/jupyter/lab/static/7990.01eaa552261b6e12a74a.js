    ...
    7990: (e, t, r) => {
      ...
      (function (e, t) {
        ...
        l(
          ...
          "(?:".concat(a[o.NUMERICIDENTIFIERLOOSE], "|").concat(a[o.NONNUMERICIDENTIFIER], ")"),
        );
        l("PRERELEASE", "(?:-(".concat(a[o.PRERELEASEIDENTIFIER], "(?:\\.").concat(a[o.PRERELEASEIDENTIFIER], ")*))"));
        l(
          "PRERELEASELOOSE",
          "(?:-?(".concat(a[o.PRERELEASEIDENTIFIERLOOSE], "(?:\\.").concat(a[o.PRERELEASEIDENTIFIERLOOSE], ")*))"),
        );
        ...
        l(
          "LOOSEPLAIN",
          "[v=\\s]*".concat(a[o.MAINVERSIONLOOSE]).concat(a[o.PRERELEASELOOSE], "?").concat(a[o.BUILD], "?"),
        );
        ...
        l(
          "COMPARATORTRIM",
          "(\\s*)".concat(a[o.GTLT], "\\s*(").concat(a[o.LOOSEPLAIN], "|").concat(a[o.XRANGEPLAIN], ")"),
          true,
        );
        t.comparatorTrimReplace = "$1$2$3";
        l(
          "HYPHENRANGE",
          "^\\s*(".concat(a[o.XRANGEPLAIN], ")") + "\\s+-\\s+" + "(".concat(a[o.XRANGEPLAIN], ")") + "\\s*$",
        );
        l(
          "HYPHENRANGELOOSE",
          "^\\s*(".concat(a[o.XRANGEPLAINLOOSE], ")") + "\\s+-\\s+" + "(".concat(a[o.XRANGEPLAINLOOSE], ")") + "\\s*$",
        );
        l("STAR", "(<|>)?=?\\s*\\*");
        l("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$");
        ...
        class e {
          ...
          intersects(t, r) {
            ...
            return this.set.some(
              (e) => d(e, r) && t.set.some((t) => d(t, r) && e.every((e) => t.every((t) => e.intersects(t, r)))),
            );
          }
          test(e) {
            if (!e) {
      ...
      function $a(e) {
        var t, r;
        var n =
          (t = (r = e.usermeta) === null || r === void 0 ? void 0 : r.embedOptions) !== null && t !== void 0 ? t : {};
                ...
                while (1)
                  switch ((se.prev = se.next)) {
                    case 0:
                      ...
                      p = f.theme
                        ? (0, X.mergeConfig)(a[f.theme], (n = f.config) !== null && n !== void 0 ? n : {})
                        : f.config;
                      d = (0, X.isBoolean)(f.actions)
                        ? f.actions
                        : Ki({}, Ca, (i = f.actions) !== null && i !== void 0 ? i : {});
                      v = La(La({}, Fa), f.i18n);
                    ...
                    case 12:
                      if (f.defaultStyle !== false) {
                        ...
                        if (!x.getElementById(E)) {
                          ...
                          A.id = E;
                          A.innerHTML =
                            f.defaultStyle === undefined || f.defaultStyle === true ? Zi.toString() : f.defaultStyle;
                          O.appendChild(A);
                        }
                      }
                      N = Ua(r, f.mode);
                      ...
                      P = new (f.viewClass || Ra.View)(
                        ...
                        La(
                          ...
                          F
                            ? {
                                expr:
                                  (c = (u = Ra.expressionInterpreter) !== null && u !== void 0 ? u : f.expr) !== null &&
                                  c !== void 0
                                    ? c
                                    : ne,
                              }
