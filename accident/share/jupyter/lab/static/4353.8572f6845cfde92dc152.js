    ...
    44353: (e, t, n) => {
      ...
      function C(e) {
        ...
        for (let n of e.selection.ranges) {
          ...
          if (o.from > r.from && o.from == n.to) o = n.to == r.to + 1 ? r : e.doc.lineAt(n.to - 1);
          let l = t.length - 1;
      ...
      function z(e, t) {
        return (
          e.ranges.length == t.ranges.length && e.ranges.filter((e, n) => e.empty != t.ranges[n].empty).length === 0
        );
      }
      function _(e, t) {
      ...
      function K(e, t) {
        if (!e.length) {
          ...
          let n = e[e.length - 1];
          let r = n.selectionsAfter.slice(Math.max(0, n.selectionsAfter.length - q));
      ...
      function fe(e, t, n) {
        let o = t.head,
          l = e.doc.lineAt(o);
        if (o == (n ? l.to : l.from)) o = n ? Math.min(e.doc.length, l.to + 1) : Math.max(0, l.from - 1);
      ...
      const ve = (e) => re(e, (t) => (t.empty ? e.moveByChar(t, true, (n) => Se(e, t.head, n)) : oe(t, true)));
      const Ae =
        typeof Intl != "undefined" && Intl.Segmenter ? new Intl.Segmenter(undefined, { granularity: "word" }) : null;
      function Ce(e, t, n) {
        ...
        let f = (t) => {
          ...
          if (l == r.CharCategory.Word) {
            if (t.toLowerCase() == t) {
              ...
              if (c && n && o((d = e.state.sliceDoc(s, s + 1))) == r.CharCategory.Word && d.toLowerCase() == d)
                return false;
              c = true;
            }
          }
        ...
        if (Ae && l == r.CharCategory.Word && d.from == t.from + i * (n ? 1 : -1)) {
      ...
      function Le(e, t, n) {
        ...
        let s = o.type.prop(l),
          a,
          u;
        if (s && (a = n ? (0, i.matchBrackets)(e, o.from, 1) : (0, i.matchBrackets)(e, o.to, -1)) && a.matched)
      ...
      function Ve(e, t) {
        ...
        if (n.selfScroll) {
          ...
          if (t && t.top > a && t.bottom < c)
            s = l.EditorView.scrollIntoView(o.main.head, { y: "start", yMargin: t.top - a });
        }
      ...
      const We = (e) => re(e, (t) => r.EditorSelection.cursor(e.lineBlockAt(t.head).from, 1));
      const ze = (e) => re(e, (t) => r.EditorSelection.cursor(e.lineBlockAt(t.head).to, -1));
      function _e(e, t, n) {
        let o = false,
          l = te(e.selection, (t) => {
            let l =
      ...
      const it = (e) => Ke(e, (t) => e.moveByChar(t, true, (n) => Se(e, t.head, n)));
      function at(e, t) {
      ...
      const Ct = (e) => Ke(e, (t) => r.EditorSelection.cursor(e.lineBlockAt(t.head).from));
      const Bt = (e) => Ke(e, (t) => r.EditorSelection.cursor(e.lineBlockAt(t.head).to));
      ...
      const bt = ({ state: e, dispatch: t }) => {
        let n = $t(e).map(({ from: t, to: n }) => r.EditorSelection.range(t, Math.min(n + 1, e.doc.length)));
      ...
      const Tt = ({ state: e, dispatch: t }) => {
        let n = te(e.selection, (t) => {
          ...
          for (let e = o; e; e = e.next) {
            let { node: n } = e;
            if (((n.from < t.from && n.to >= t.to) || (n.to > t.to && n.from <= t.from)) && e.next)
      ...
      function It(e, t) {
        ...
        let s = o.changeByRange((o) => {
          ...
          return l == s
            ? { range: o }
            : { changes: { from: l, to: s }, range: r.EditorSelection.cursor(l, l < o.head ? -1 : 1) };
        });
      ...
      const Vt = (e, t, n) =>
        It(e, (o) => {
          let l = o.from,
            ...
            c,
            u;
          if (n && !t && l > a.from && l < a.from + 200 && !/[^ \t]/.test((c = a.text.slice(0, l - a.from)))) {
            ...
            else if (!t && /[\ufe00-\ufe0f]/.test(a.text.slice(u - a.from, l - a.from)))
              u = (0, r.findClusterBreak)(a.text, u - a.from, false, false) + a.from;
          }
          return u;
        });
      ...
      const Kt = ({ state: e, dispatch: t }) => {
        ...
        let n = e.changeByRange((t) => {
          ...
          return {
            changes: { from: l, to: s, insert: e.doc.slice(n, s).append(e.doc.slice(l, n)) },
        ...
        for (let s of $t(e)) {
          ...
          if (n) {
            ...
            for (let t of s.ranges)
              l.push(r.EditorSelection.range(Math.min(e.doc.length, t.anchor + i), Math.min(e.doc.length, t.head + i)));
          } else {
      ...
      const nn = (e) => {
        ...
        let r = te(t.selection, (t) => {
          ...
          if (e.lineWrapping) {
            ...
            if (o) n = r.bottom + e.documentTop - o.bottom + e.defaultLineHeight / 2;
          }
      ...
      const gn = ({ state: e, dispatch: t }) => {
        if (e.selection.ranges.some((e) => !e.empty)) return dn({ state: e, dispatch: t });
      ...
      const kn = [
        ...
        { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: ge, shift: rt, preventDefault: true },
        { mac: "Cmd-ArrowLeft", run: Pe, shift: vt, preventDefault: true },
        { key: "ArrowRight", run: ae, shift: Xe, preventDefault: true },
        { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: ye, shift: ot, preventDefault: true },
