...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [7879],
  {
    ...
    37879: (t, e, n) => {
      ...
      function St(t, e, n, i) {
        const r =
          n <= 1 ? t : i ? (e, r) => i + n * Math.floor((t(e, r) - i) / n) : (e, i) => n * Math.floor(t(e, i) / n);
      ...
      const os = {
        ...
        stdev: {
          value: (t) => (t.valid > 1 ? Math.sqrt(t.dev / (t.valid - 1)) : undefined),
          req: ["variance"],
          idx: 2,
        },
        stdevp: { value: (t) => (t.valid > 1 ? Math.sqrt(t.dev / t.valid) : undefined), req: ["variance"], idx: 2 },
        stderr: {
          value: (t) => (t.valid > 1 ? Math.sqrt(t.dev / (t.valid * (t.valid - 1))) : undefined),
          req: ["variance"],
          idx: 2,
        },
      ...
      function du(t) {
        return t === Math.E
          ? Math.log
          : (t === 10 && Math.log10) || (t === 2 && Math.log2) || ((t = Math.log(t)), (e) => Math.log(e) / t);
      }
      function hu(t) {
        return (e, n) => -t(-e, n);
      }
      ...
      function Cu() {
        return su.C.apply(
          (0, Mu.B)(Du.$Z, Du.lk, W.Mb, X.R6, Y.Hl, G.dA, H.pz, V.vD, Q.R, fe.aL).domain([
            Date.UTC(2e3, 0, 1),
            Date.UTC(2e3, 0, 2),
          ]),
          arguments,
      ...
      function Bu() {
        ...
        function l(t) {
          return t == null || isNaN((t = +t))
            ? u
            : a(r === 0 ? 0.5 : ((t = (s(t) - n) * r), o ? Math.max(0, Math.min(1, t)) : t));
        }
        l.domain = function (a) {
          return arguments.length
            ? (([t, e] = a), (n = s((t = +t))), (i = s((e = +e))), (r = n === i ? 0 : 1 / (i - n)), l)
            : [t, e];
        };
        l.clamp = function (t) {
      ...
      function Pu() {
        ...
        function h(t) {
          return isNaN((t = +t))
            ? d
            : ((t = 0.5 + ((t = +c(t)) - s) * (i * t < i * s ? o : u)), l(f ? Math.max(0, Math.min(1, t)) : t));
        }
        h.domain = function (l) {
          return arguments.length
            ? (([t, e, n] = l),
      ...
      const lc = {
        ...
        grays: "e2e2e2d4d4d4c4c4c4b1b1b19d9d9d8888887575756262624d4d4d3535351e1e1e",
        ...
        if ((0, p.Kg)(e)) {
          e =
            t.type === ml
              ...
              : t.type == gl
                ? It(e)
                : (0, p.z3)("Only time and utc scales accept interval strings.");
          if (i) e = e.every(i);
        }
        return e;
      }
      ...
      function Yp(t, e, n) {
        fh(e, (e) => {
          var i = e.opacity == null ? 1 : e.opacity,
            ...
            l,
            c;
          if ((n && !n.intersects(e.bounds)) || i === 0 || e.fontSize <= 0 || e.text == null || e.text.length === 0)
            return;
          t.font = Lp(e);
      ...
      function vg(t) {
        ...
        return (
          `${u}-axis` + (i ? ` titled '${i}'` : "") + ` for a ${Vl(o) ? "discrete" : o} scale` + ` with ${Ic(a, s, t)}`
        );
      }
      function bg(t) {
        const e = t.datum,
      ...
      const kg = (t) =>
        Ag(t).replace(/"/g, "&quot;").replace(/\t/g, "&#x9;").replace(/\n/g, "&#xA;").replace(/\r/g, "&#xD;");
      function Eg() {
        let t = "",
          e = "",
          n = "";
        ...
        transform(t, e) {
          ...
          if (s === mc) {
            ...
            if (y) {
              y = f[r.length];
              r.push(
                bn({ index: r.length, label: `…${f.length - r.length} entries`, value: y, offset: g, size: m(y, t) }),
              );
            }
          } else if (s === yc) {
            ...
            h = Pc(a);
            r = f.map((t, e) =>
              bn({ index: e, label: c(t, e, f), value: t, perc: e ? h(t) : 0, perc2: e === m ? 1 : h(f[e + 1]) }),
            );
          }
          i.source = r;
          i.add = r;
      ...
      const Ab = (t, e, n, i) => {
        const r = Math.cos(t),
          ...
          u = (e + i) / 2;
        return (
          "M" + e * r + "," + e * s + "C" + u * r + "," + u * s + " " + u * a + "," + u * o + " " + i * a + "," + i * o
        );
      };
      const kb = (0, p.nG)({
        line: db,
        ...
        D.clipExtent = function (t) {
          return arguments.length
            ? ((x =
                t == null
                  ? ((g = y = v = b = null), Jb)
                  : bw((g = +t[0][0]), (y = +t[0][1]), (v = +t[1][0]), (b = +t[1][1]))),
              S())
            : g == null
              ? null
              : [
      ...
      function oA(t) {
        ...
        e.clipExtent = function (t) {
          return arguments.length
            ? (t == null ? (a = o = u = l = null) : ((a = +t[0][0]), (o = +t[0][1]), (u = +t[1][0]), (l = +t[1][1])),
              c())
            : a == null
              ? null
              : [
        ...
        b.clipExtent = function (t) {
          return arguments.length
            ? ((m =
                t == null
                  ? ((u = l = c = f = null), Jb)
                  : bw((u = +t[0][0]), (l = +t[0][1]), (c = +t[1][0]), (f = +t[1][1]))),
              v())
            : u == null
              ? null
              : [
      ...
      function Dk() {
        ...
        y.outline = function () {
          return {
            type: "Polygon",
            coordinates: [p(i).concat(m(a).slice(1), p(n).reverse().slice(1), m(o).reverse().slice(1))],
          };
        };
        y.extent = function (t) {
      ...
      function YS(t, e, n, i, r, s, a, o, u) {
        ...
        if (c !== 0 || h !== 0) {
          ...
          if (c !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * G, OS), OS, scale(e, RS, c, TS), TS, scale(t, NS, c, LS), LS, PS, IS),
              IS,
            );
            if (p !== 0) {
          ...
          if (h !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * X, OS), OS, scale(e, RS, h, TS), TS, scale(t, NS, h, LS), LS, PS, IS),
              IS,
            );
          }
        }
        if (f !== 0 || p !== 0) {
          ...
          if (f !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * Y, OS), OS, scale(e, RS, f, TS), TS, scale(t, NS, f, LS), LS, PS, IS),
              IS,
            );
            if (m !== 0) {
          ...
          if (p !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * H, OS), OS, scale(e, RS, p, TS), TS, scale(t, NS, p, LS), LS, PS, IS),
              IS,
            );
          }
        }
        if (d !== 0 || m !== 0) {
          ...
          if (d !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * W, OS), OS, scale(e, RS, d, TS), TS, scale(t, NS, d, LS), LS, PS, IS),
              IS,
            );
            if (h !== 0) {
          ...
          if (m !== 0) {
            ...
            l = GS(
              l,
              sum_three(scale(e, RS, 2 * V, OS), OS, scale(e, RS, m, TS), TS, scale(t, NS, m, LS), LS, PS, IS),
              IS,
            );
          }
        }
        ...
        *neighbors(t) {
        ...
        _clip(t) {
          ...
          return this._simplify(
            n[i] || n[i + 1] ? this._clipInfinite(t, e, n[i], n[i + 1], n[i + 2], n[i + 3]) : this._clipFinite(t, e),
          );
        }
        _clipFinite(t, e) {
          const n = e.length;
      ...
      function pT(t, e) {
        ...
        var n = xx(e),
          ...
          s = Dx(e),
          a = bx(
            Fx((a = oT * s - uT * r) * a + (a = uT * i - aT * s) * a + (a = aT * r - oT * i) * a),
            aT * i + oT * r + uT * s,
          );
        HO += a;
        ZO += a * (aT + (aT = i));
      ...
      function tN(t, e) {
        return t.map((t) =>
          (0, p.X$)(e.fields ? { values: e.fields.map((e) => DT(e)(t.datum)) } : { [RT]: OT(t.datum) }, e),
        );
      }
      function eN(t, e, n, i) {
      ...
      function _q(t) {
        return (0, p.Gv)(t)
          ? { top: bq(t.top), bottom: bq(t.bottom), left: bq(t.left), right: bq(t.right) }
          : xq(bq(t));
      }
      ...
      function iI(t) {
        return !(0, p.Gv)(t)
          ...
          : t.signal
            ? t
            : { top: eI(t.top), bottom: eI(t.bottom), left: eI(t.left), right: eI(t.right) };
      }
      ...
      function sU(t, e) {
        return (
          (t && t.signal ? "$" + t.signal : t || "") + (t && e ? "_" : "") + (e && e.signal ? "$" + e.signal : e || "")
        );
      }
      const aU = "scope";
      const oU = "view";
      ...
      function gG(t, e, n, i) {
        ...
        aI(
          h,
          { stroke: r("gradientStrokeColor"), strokeWidth: r("gradientStrokeWidth") },
      ...
      function yG(t, e, n, i, r) {
        ...
        aI(
          g,
          { stroke: s("gradientStrokeColor"), strokeWidth: s("gradientStrokeWidth") },
      ...
      function TG(t) {
        const e = t.role || "";
        return e.startsWith("axis") || e.startsWith("legend") || e.startsWith("title")
          ? e
          : t.type === nG
            ? fI
            : e || lI;
      ...
      function ZY(t, e, n, i, r) {
        return {
          signal:
            'flush(range("' + t + '"), ' + 'scale("' + t + '", datum.value), ' + e + "," + n + "," + i + "," + r + ")",
        };
      }
      ...
      lW.prototype = cW.prototype = {
        ...
        compareRef(t) {
          let e = false;
          const n = (t) =>
            uU(t) ? ((e = true), this.signalRef(t.signal)) : lU(t) ? ((e = true), this.exprRef(t.expr)) : t;
