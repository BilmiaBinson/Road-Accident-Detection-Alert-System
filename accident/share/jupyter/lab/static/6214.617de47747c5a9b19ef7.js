  ...
  [6214],
  {
    26214: (t, e, n) => {
      ...
      var c = (function () {
        ...
        var h = {
          ...
          table: [
            ...
            t(e, [2, 7], { 1: [2, 1] }),
            t(e, [2, 3]),
            { 9: 18, 11: n, 12: r, 14: s, 16: a, 17: o, 18: 14, 19: 15, 20: c, 21: l },
            t(e, [2, 5]),
            t(e, [2, 6]),
            t(e, [2, 8]),
            { 13: [1, 19] },
            ...
            while (true) {
              ...
              switch ($[0]) {
                ...
                case 2:
                  ...
                  T = this.performAction.apply(I, [l, d, h, m.yy, $[1], a, o].concat(y));
      ...
      var v = (0, i.K2)(function (t, e, n) {
        const i = { id: u++, section: d, type: d, task: t, score: e ? e : 0, events: n ? [n] : [] };
        y.push(i);
      }, "addTask");
      ...
      var L = (0, i.K2)(function (t, e, n) {
        ...
        r.ry = 3;
        E(i, r);
        O(n)(e.text, i, r.x, r.y, r.width, r.height, { class: "journey-section section-type-" + e.num }, n, e.color);
      }, "drawSection");
      var M = -1;
      var C = (0, i.K2)(function (t, e, n) {
        ...
        a.ry = 3;
        E(r, a);
        O(n)(e.task, r, a.x, a.y, a.width, a.height, { class: "task" }, n, e.color);
      }, "drawTask");
      ...
      var z = (0, i.K2)(function (t, e, n, i) {
        ...
        const s = t.append("g");
        e.section = r;
        s.attr("class", (e.class ? e.class + " " : "") + "timeline-node " + ("section-" + r));
        const a = s.append("g");
        const o = s.append("g");
        const c = o
          .append("text")
        ...
        const h = i.fontSize?.replace ? i.fontSize.replace("px", "") : i.fontSize;
      ...
      var W = (0, i.K2)(function (t, e, n) {
        ...
        const a = n.fontSize?.replace ? n.fontSize.replace("px", "") : n.fontSize;
        i.remove();
      ...
      var V = (0, i.K2)(function (t, e, n, s) {
        ...
        const h = c === "sandbox" ? (0, r.Ltv)(l.nodes()[0].contentDocument.body) : (0, r.Ltv)("body");
        const d = h.select("#" + e);
        d.append("g");
        ...
        f.forEach(function (t) {
          const e = { number: v, descr: t, section: v, width: 150, padding: 20, maxHeight: y };
        ...
        for (const [r, E] of u.entries()) {
          const t = { number: r, descr: E, section: E.section, width: 150, padding: 20, maxHeight: g };
          ...
          for (const i of E.events) {
            const t = { descr: i, section: E.section, number: E.section, width: 150, padding: 20, maxHeight: 50 };
        ...
        (0, i.ot)(void 0, d, a.timeline?.padding ?? 50, a.timeline?.useMaxWidth ?? false);
      }, "draw");
