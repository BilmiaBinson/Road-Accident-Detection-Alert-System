  ...
  [8103],
  {
    88103: (O, Q, e) => {
      ...
      const H = {
        ...
        facet: (0, d.defineLanguageFacet)({ commentTokens: { block: { open: "{/*", close: "*/}" } } }),
      };
      ...
      const F = B.configure(
        { dialect: "jsx ts", props: [d.sublanguageProp.add((O) => (O.isTop ? [H] : undefined))] },
        "typescript",
      );
          ...
          if ($.doc.sliceString(e - 1, e) != a || (i.name == "JSXAttributeValue" && i.to > e));
            ...
            if (
              ...
              ((t = tO($.doc, a.firstChild, e)) ||
                ((Q = a.firstChild) === null || Q === void 0 ? void 0 : Q.name) == "JSXFragmentTag")
            ) {
              let O = `${t}>`;
