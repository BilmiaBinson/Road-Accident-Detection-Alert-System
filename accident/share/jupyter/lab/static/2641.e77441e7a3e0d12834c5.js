(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [2641],
  {
    8394: (e, t, r) => {
      ...
      I[c] = I[u] = I[C] = I[l] = I[R] = I[d] = I[h] = I[p] = I[m] = I[y] = I[v] = I[w] = I[T] = I[E] = I[k] = false;
      ...
      function Ie() {
        this.size = 0;
        this.__data__ = { hash: new Re(), map: new (Se || xe)(), string: new Re() };
      }
      function Be(e) {
    ...
    59850: (e, t, r) => {
      ...
      (function (e) {
        ...
        function t(t) {
          ...
          return (
            r &&
            (r === e.None || r === e.Cancelled || (s.boolean(r.isCancellationRequested) && !!r.onCancellationRequested))
          );
        }
        e.is = t;
    ...
    90577: (e, t, r) => {
      ...
      (function (e) {
        function t(e) {
          const t = e;
          return t && (C.is(t.cancellationStrategy) || w.is(t.connectionStrategy) || R.is(t.messageStrategy));
        }
        e.is = t;
      ...
      function O(e, r, d, g) {
        ...
        const K = g && g.cancellationStrategy ? g.cancellationStrategy : C.Message;
        function Q(e) {
          if (e === null) {
        ...
        function be(e, t, r) {
          ...
          if (B === m.Text) {
            ...
            W.log(`Sending response '${t} - (${e.id})'. Processing request took ${Date.now() - r}ms`, n);
          } else {
            Te("send-response", e);
          }
        }
        ...
        function we(e, t) {
          ...
          if (B === m.Text) {
            ...
            if (t) {
              ...
              W.log(`Received response '${t.method} - (${e.id})' in ${Date.now() - t.timerStart}ms.${n}`, r);
            } else {
              W.log(`Received response ${e.id} without active response promise.`, r);
            }
          } else {
          ...
          sendRequest: (e, ...t) => {
            ...
            if (a) {
              f = a.onCancellationRequested(() => {
                ...
                if (e === undefined) {
                  w.log(`Received no promise from cancellation strategy when canceling id ${u}`);
                  return Promise.resolve();
                } else {
                  return e.catch(() => {
