(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [9046, 5606],
  {
    ...
    63616: (t, e, n) => {
      "use strict";
      n.d(e, { RI: () => s, T9: () => g, jk: () => f, sj: () => b, tn: () => i });
      const s = Math.floor;
      const r = Math.ceil;
      const i = Math.abs;
      const o = Math.imul;
    ...
    5739: (t, e, n) => {
      ...
      class o {
        ...
        emit(t, e) {
          return i.HT((this._observers.get(t) || s.vt()).values()).forEach((t) => t(...e));
        }
        destroy() {
          this._observers = s.vt();
        }
    ...
    66665: (t, e, n) => {
      ...
      var I = n(53110);
      var M = n(65606);
      const U = typeof M !== "undefined" && M.release && /node|io\.js/.test(M.release.name);
      const O = typeof window !== "undefined" && typeof document !== "undefined" && !U;
      ...
      const H =
        !P("no-colors") &&
        (!U || M.stdout.isTTY || $) &&
        (!U || P("color") || $ || B("COLORTERM") !== null || (B("TERM") || "").includes("color"));
      ...
      const X = (t) => Buffer.from(t.buffer, t.byteOffset, t.byteLength).toString("base64");
      const G = (t) => {
        const e = atob(t);
        const n = W(e.length);
      ...
      const me = null && 1 << 31;
      const ye = fe;
      const be = Number.isInteger || ((t) => typeof t === "number" && isFinite(t) && i.RI(t) === t);
      ...
      const xn = (t) =>
        (t.arr[t.pos] + (t.arr[t.pos + 1] << 8) + (t.arr[t.pos + 2] << 16) + (t.arr[t.pos + 3] << 24)) >>> 0;
      const In = (t) => {
        let e = 0;
        let n = 1;
      ...
      const qs = (t) => Ts.parseFromString(`<html><body>${t}</body></html>`, "text/html").body;
      ...
      const Vr = "font-family:monospace;border-bottom:1px solid #e2e2e2;padding:2px;";
      class Pr {
        constructor(t) {
          this.dom = t;
        ...
        group(t, e = false) {
          eventloop.enqueue(() => {
            const n = dom.element(
              "span",
              [pair.create("hidden", e), pair.create("style", "color:grey;font-size:120%;")],
              [dom.text("▼")],
            );
            const s = dom.element(
              "span",
              [pair.create("hidden", !e), pair.create("style", "color:grey;font-size:125%;")],
              [dom.text("▶")],
            );
            const r = dom.element(
              "div",
        ...
        print(t) {
          eventloop.enqueue(() => {
            dom.append(this.ccontainer, [
              dom.element("div", [pair.create("style", `${Vr};padding-left:${this.depth * 10}px`)], Rr(t)),
            ]);
          });
        }
        printError(t) {
        ...
        printImg(t, e) {
          eventloop.enqueue(() => {
            dom.append(this.ccontainer, [
              dom.element("img", [pair.create("src", t), pair.create("height", `${math.round(e * 1.5)}px`)]),
            ]);
          });
        }
        printDom(t) {
        ...
        return !s
          ...
          : (...n) => {
              ...
              Dr(
                ...
                t,
                yr,
                ...n.map((t) => (typeof t === "string" || typeof t === "symbol" ? t : JSON.stringify(t))),
                e,
                " +" + r + "ms",
              );
            };
      ...
      class gi extends fi {
        ...
        readLeftID() {
          return new zi(this.clientDecoder.read(), this.leftClockDecoder.read());
        }
        readRightID() {
          return new zi(this.clientDecoder.read(), this.rightClockDecoder.read());
        }
        readClient() {
      ...
      const ko = (t, e) =>
        e === undefined
          ? !t.deleted
          : e.sv.has(t.id.client) && (e.sv.get(t.id.client) || 0) > t.id.clock && !ti(e.ds, t.id);
      const _o = (t, e) => {
      ...
      const Ro = (t, e) => {
        if (e.deleteSet.clients.size === 0 && !o.bz(e.afterState, (t, n) => e.beforeState.get(n) !== t)) {
          return false;
        }
        ei(e.deleteSet);
        Ei(t, e);
      ...
      const jo = (t, e, n) => {
        for (const [s, r] of t.clients.entries()) {
          ...
          for (let s = r.length - 1; s >= 0; s--) {
            ...
            for (let s = Ao(t, i.clock), r = t[s]; s < t.length && r.id.clock < o; r = t[++s]) {
              const r = t[s];
        ...
        Jo(
          ...
          (n) => {
            while (e.length > 0 && s === null) {
              ...
              Qr(n, c.deletions, (t) => {
                if (t instanceof ch && o.some((e) => qi(e, t)) && !ti(c.insertions, t.id)) {
                  l.add(t);
                }
              });
              l.forEach((e) => {
            ...
            if (e !== i.struct.id.client) {
              ...
              if (i.struct.id.clock + i.struct.length < n.id.clock) {
                if (i.struct.constructor === uh) {
                  ...
                  const s = new uh($i(e, i.struct.id.clock + i.struct.length), t);
                  i = { struct: s, offset: 0 };
                }
              } else {
      ...
      const Cc = (t, e) => {
        ...
        const n =
          t._searchMarker.length === 0
            ? null
            : t._searchMarker.reduce((t, n) => (i.tn(e - t.index) < i.tn(e - n.index) ? t : n));
        let s = t._start;
        let r = 0;
        if (n !== null) {
          s = n.p;
      ...
      const Rc = (t, e, n, s) => {
        ...
        const a = () => {
          if (h.length > 0) {
            r = new ch($i(o, Do(c, o)), r, r && r.lastId, l, l && l.id, e, null, new Jl(h));
            r.integrate(t, 0);
            h = [];
          }
        };
            ...
            switch (n.constructor) {
              ...
              default:
                ...
                switch (n.constructor) {
                  case Uint8Array:
                  case ArrayBuffer:
                    r = new ch($i(o, Do(c, o)), r, r && r.lastId, l, l && l.id, e, null, new Il(new Uint8Array(n)));
                    r.integrate(t, 0);
                    break;
                  case ai:
                    r = new ch($i(o, Do(c, o)), r, r && r.lastId, l, l && l.id, e, null, new Nl(n));
                    r.integrate(t, 0);
                    break;
                  default:
                    if (n instanceof Tc) {
                      r = new ch($i(o, Do(c, o)), r, r && r.lastId, l, l && l.id, e, null, new eh(n));
                      r.integrate(t, 0);
                    } else {
      ...
      const zc = (t, e, n, s) => {
        ...
        new ch($i(o, Do(i.store, o)), r, r && r.lastId, null, null, e, n, c).integrate(t, 0);
      };
      const Jc = (t, e) => {
      ...
      class Qc extends Tc {
        ...
        values() {
          return Kr(Kc(this._map), (t) => t[1].content.getContent()[t[1].length - 1]);
        }
        entries() {
          return Kr(Kc(this._map), (t) => [t[0], t[1].content.getContent()[t[1].length - 1]]);
        }
        forEach(t) {
          this._map.forEach((e, n) => {
            if (!e.deleted) {
      ...
      const Zc = (t) => new Qc();
      const tl = (t, e) => t === e || (typeof t === "object" && typeof e === "object" && t && e && qr.SQ(t, e));
      class el {
        constructor(t, e, n, s) {
          this.left = t;
          this.right = e;
      ...
      const rl = (t, e, n, s) => {
        while (
          ...
          (n.right.deleted === true ||
            (n.right.content.constructor === jl && tl(s.get(n.right.content.key), n.right.content.value)))
        ) {
          if (!n.right.deleted) {
        ...
        s.forEach((s, o) => {
          const c = n.left;
          const l = n.right;
          const h = new ch($i(i, Do(r.store, i)), c, c && c.lastId, l, l && l.id, e, null, new jl(o, s));
          h.integrate(t, 0);
          n.right = h;
          n.forward();
        });
      ...
      const ol = (t, e) => {
        while (true) {
          if (t.right === null) {
            ...
            t.right.deleted ||
            (t.right.content.constructor === jl && tl(e[t.right.content.key] || null, t.right.content.value))
          );
          else {
            break;
          }
      ...
      const cl = (t, e, n, s) => {
        ...
        for (const c in s) {
          ...
          if (!tl(h, l)) {
            ...
            n.right = new ch($i(i, Do(r.store, i)), s, s && s.lastId, a, a && a.id, e, null, new jl(c, l));
      ...
      const ll = (t, e, n, s, r) => {
        ...
        ol(n, r);
        const c = cl(t, e, n, r);
        const l = s.constructor === String ? new Hl(s) : s instanceof Tc ? new eh(s) : new Vl(s);
        let { left: h, right: a, index: u } = n;
        if (e._searchMarker) {
          Dc(e._searchMarker, n.index, l.getLength());
        }
        a = new ch($i(o, Do(i.store, o)), h, h && h.lastId, a, a && a.id, e, null, l);
        a.integrate(t, 0);
        n.right = a;
        n.index = u;
        n.forward();
      ...
      const hl = (t, e, n, s, r) => {
        ...
        t: while (
          n.right !== null &&
          (s > 0 || (c.size > 0 && (n.right.deleted || n.right.content.constructor === jl)))
        ) {
          if (!n.right.deleted) {
      ...
      class yl extends Tc {
        ...
        querySelectorAll(t) {
          t = t.toUpperCase();
          return r.HT(new ml(this, (e) => e.nodeName && e.nodeName.toUpperCase() === t));
        }
        _callObserver(t, e) {
      ...
      class ch extends Al {
        ...
        getMissing(t, e) {
          ...
          if ((this.left && this.left.constructor === xl) || (this.right && this.right.constructor === xl)) {
            this.parent = null;
          }
          if (!this.parent) {
        ...
        integrate(t, e) {
          if (e > 0) {
            this.id.clock += e;
            this.left = Uo(t, t.doc.store, $i(this.id.client, this.id.clock - 1));
            this.origin = this.left.lastId;
          ...
          if (this.parent) {
            if (
              ...
              while (n !== null && n !== this.right) {
                ...
                } else if (n.origin !== null && r.has(xo(t.doc.store, n.origin))) {
        ...
        write(t, e) {
          const n = e > 0 ? $i(this.id.client, this.id.clock + e - 1) : this.origin;
          const s = this.rightOrigin;
          const r = this.parentSub;
          const i =
            (this.content.getRef() & Ft) | (n === null ? 0 : ut) | (s === null ? 0 : at) | (r === null ? 0 : ht);
          t.writeInfo(i);
          if (n !== null) {
            t.writeLeftID(n);
          }
