...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [247],
  {
    90247: (e, t, n) => {
      ...
      i("def", "if while until for do do; end end; then else cancel", ["inDataStep"]);
      ...
      i("def", "filevar finfo finv fipname fipnamel fipstate first firstobs floor", ["inDataStep"]);
      i(
        "def",
      ...
      i("builtin", "proc run; quit; libname filename %macro %mend option options", ["ALL"]);
      ...
      function l(e, t) {
        ...
        if ((n === '"' || n === "'") && !t.continueString) {
          ...
          else if (n === "0") e.match(/^[xX][0-9a-fA-F]+/) || e.match(/^0[0-7]+/);
        ...
        if (t.inDataStep) {
          ...
          if (
            l &&
            r.hasOwnProperty(l) &&
            (r[l].state.indexOf("inDataStep") !== -1 || r[l].state.indexOf("ALL") !== -1)
          ) {
        ...
        if (t.inProc) {
          ...
          if (l && r.hasOwnProperty(l) && (r[l].state.indexOf("inProc") !== -1 || r[l].state.indexOf("ALL") !== -1)) {
            e.match(/[\w]+/);
            return r[l].style;
          }
        }
        if (t.inMacro) {
          ...
          if (l && r.hasOwnProperty(l) && (r[l].state.indexOf("inMacro") !== -1 || r[l].state.indexOf("ALL") !== -1)) {
            e.match(/[\w]+/);
            return r[l].style;
          }
          return "atom";
        ...
        if (l && r.hasOwnProperty(l)) {
          ...
          if (t.inDataStep === true && r[l].state.indexOf("inDataStep") !== -1) return r[l].style;
          if (t.inProc === true && r[l].state.indexOf("inProc") !== -1) return r[l].style;
          if (t.inMacro === true && r[l].state.indexOf("inMacro") !== -1) return r[l].style;
