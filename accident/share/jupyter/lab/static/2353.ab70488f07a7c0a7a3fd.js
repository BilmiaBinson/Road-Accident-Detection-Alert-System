  ...
  [2353, 4981],
  {
      ...
      var l = (function (t) {
        ...
        r.prototype.setInheritedAttributes = function (t, e, i, n) {
          ...
          if (
            N >= 0 &&
            N !== Infinity &&
            ((N === 1 && this.childNodes.length === 0) || (N !== 1 && this.childNodes.length !== N))
          ) {
        ...
        r.prototype.verifyTree = function (t) {
          ...
          if (t["checkArity"]) {
            if (
              e >= 0 &&
              e !== Infinity &&
              ((e === 1 && this.childNodes.length === 0) || (e !== 1 && this.childNodes.length !== e))
            ) {
      ...
      var M = (function (t) {
        ...
        e.prototype.adjustTeXclass = function (t) {
          ...
          if (
            ...
            r === E.TEXCLASS.BIN &&
            (e === E.TEXCLASS.REL || e === E.TEXCLASS.CLOSE || e === E.TEXCLASS.PUNCT)
          ) {
            ...
            while (
              ...
              n.parent &&
              n.isEmbellished &&
              (n.childNodes.length === 1 || (!n.isKind("mrow") && n.core() === i))
            ) {
              i = n;
              n = n.parent;
            }
        ...
        e.mathaccents = new RegExp(
          ["^[", "´́ˊ", "`̀ˋ", "¨̈", "~̃˜", "¯̄ˉ", "˘̆", "ˇ̌", "^̂ˆ", "→⃗", "˙̇", "˚̊", "⃛", "⃜", "]$"].join(""),
        );
        return e;
      })(E.AbstractMmlTokenNode);
      e.MmlMo = M;
    ...
    56893: function (t, e, r) {
      ...
      e.RANGES = [
        ...
        [131072, 195103, n.TEXCLASS.ORD, "mi", "normal"],
      ];
      function o(t) {
        var r, n;
