  ...
  [4364],
  {
    54364: (e, t, n) => {
      ...
      const re = o(/^!?\[(ref)\](?:\[\])?/)
        .replace("ref", m)
        .getRegex();
      const ie = o("reflink|nolink(?!\\()", "g").replace("reflink", se).replace("nolink", re).getRegex();
      const le = {
        _backpedal: l,
        anyPunctuation: V,
        autolink: W,
      ...
      const ae = {
        ...
        emStrongRDelimAst: J,
        emStrongLDelim: X,
        url: o(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, "i")
      ...
      class ye {
        ...
        list(e) {
          ...
          if (t) {
            let n = t[1].trim();
            const s = n.length > 1;
            const r = { type: "list", raw: "", ordered: s, start: s ? +n.slice(0, -1) : "", loose: false, items: [] };
            ...
            while (e) {
              ...
              if (!n) {
                ...
                while (e) {
                  ...
                  if (f.search(this.rules.other.nonSpaceChar) >= p || !c.trim()) {
                    o += "\n" + f.slice(p);
                  } else {
                    if (h) {
                      break;
              ...
              r.items.push({ type: "list_item", raw: s, task: !!u, checked: f, loose: false, text: o, tokens: [] });
              r.raw += s;
            }
            ...
            for (let e = 0; e < r.items.length; e++) {
              ...
              if (!r.loose) {
                ...
                const n = t.length > 0 && t.some((e) => this.rules.other.anyLine.test(e.raw));
                r.loose = n;
              }
            }
            if (r.loose) {
        ...
        def(e) {
          ...
          if (t) {
            ...
            const n = t[2]
              ...
              : "";
            const s = t[3] ? t[3].substring(1, t[3].length - 1).replace(this.rules.inline.anyPunctuation, "$1") : t[3];
        ...
        table(e) {
          ...
          const n = de(t[1]);
          const s = t[2].replace(this.rules.other.tableAlignChars, "").split("|");
          const r = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [];
          const i = { type: "table", raw: t[0], header: [], align: [], rows: [] };
          ...
          for (let l = 0; l < n.length; l++) {
            i.header.push({ text: n[l], tokens: this.lexer.inline(n[l]), header: true, align: i.align[l] });
          }
          for (const l of r) {
            i.rows.push(
        ...
        link(e) {
          ...
          if (t) {
            ...
            if (this.rules.other.startAngleBracket.test(n)) {
              if (this.options.pedantic && !this.rules.other.endAngleBracket.test(e)) {
                n = n.slice(1);
              } else {
                n = n.slice(1, -1);
              }
        ...
        reflink(e, t) {
          ...
          if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
            const e = (n[2] || n[1]).replace(this.rules.other.multipleSpaceGlobal, " ");
        ...
        codespan(e) {
          ...
          if (t) {
            ...
            const s = this.rules.other.startingSpaceChar.test(e) && this.rules.other.endingSpaceChar.test(e);
            if (n && s) {
      ...
      class $e {
        ...
        inlineTokens(e, t = []) {
          ...
          if (this.tokens.links) {
            ...
            if (e.length > 0) {
              while ((s = this.tokenizer.rules.inline.reflinkSearch.exec(n)) != null) {
          ...
          if (e.task) {
            ...
            if (e.loose) {
              if (e.tokens[0]?.type === "paragraph") {
                ...
                if (e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && e.tokens[0].tokens[0].type === "text") {
                  e.tokens[0].tokens[0].text = n + " " + ge(e.tokens[0].tokens[0].text);
        ...
        parse(e, t = true) {
          ...
          for (let s = 0; s < e.length; s++) {
            ...
            if (this.options.extensions?.renderers?.[r.type]) {
              const e = r;
              const t = this.options.extensions.renderers[e.type].call({ parser: this }, e);
              if (
                t !== false ||
                ![
                  "space",
      ...
      class Ae {
        ...
        parseMarkdown(e) {
          const t = (t, n) => {
            ...
            const l = r.hooks ? r.hooks.provideLexer() : e ? $e.lex : $e.lexInline;
            const o = r.hooks ? r.hooks.provideParser() : e ? Te.parse : Te.parseInline;
            if (r.async) {
        ...
        onError(e, t) {
          return (n) => {
            ...
            if (e) {
              const e = "<p>An error occurred:</p><pre>" + ge(n.message + "", true) + "</pre>";
              if (t) {
