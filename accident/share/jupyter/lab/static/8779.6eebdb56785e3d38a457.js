  ...
  [8779],
  {
    88779: (O, Q, P) => {
      ...
      const i = (0, a.styleTags)({
        ...
        "strictfp synchronized native transient volatile throws"]: a.tags.modifier,
        ...
        parser: e.configure({
          props: [
            s.indentNodeProp.add({
              ...
              TryStatement: (0, s.continuedIndent)({ except: /^\s*({|catch|finally)\b/ }),
