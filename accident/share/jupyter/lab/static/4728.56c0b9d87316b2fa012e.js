  ...
  [4728, 5606],
  {
          ...
          while ((a = r.indexOf("&", a)) >= 0) {
            ...
            if (r.charCodeAt(a) === l.NUM) {
              ...
              do {
                ...
                (p >= l.ZERO && p <= l.NINE) ||
                (h === 16 && (p | l.To_LOWER_BIT) >= l.LOWER_A && (p | l.To_LOWER_BIT) <= l.LOWER_F)
              );
              if (u !== a) {
    ...
    11724: function (e, t, r) {
      ...
      var b = (function () {
        ...
        e.prototype.context = function (e, t) {
          ...
          this.endIndex = t - 1;
          (i = (r = this.cbs).context) === null || i === void 0 ? void 0 : i.call(r, n);
          this.startIndex = t;
        };
        e.prototype.ontextentity = function (e) {
          ...
          this.endIndex = i - 1;
          (r = (t = this.cbs).context) === null || r === void 0 ? void 0 : r.call(t, (0, a.fromCodePoint)(e));
          this.startIndex = i;
        };
        ...
        e.prototype.oncdata = function (e, t, r) {
          ...
          if (this.options.xmlMode || this.options.recognizeCDATA) {
            ...
            (o = (s = this.cbs).context) === null || o === void 0 ? void 0 : o.call(s, p);
      ...
      var p = (function () {
        ...
        e.prototype.stateText = function (e) {
          if (e === n.Lt || (!this.decodeEntities && this.fastForwardTo(n.Lt))) {
            if (this.index > this.sectionStart) {
              this.cbs.context(this.sectionStart, this.index);
            }
          ...
          if (this.sequenceIndex === this.currentSequence.length) {
            if (e === n.Gt || o(e)) {
              ...
              if (this.sectionStart < t) {
                var r = this.index;
                this.index = t;
                this.cbs.context(this.sectionStart, t);
                this.index = r;
              }
              this.isSpecial = false;
        ...
        e.prototype.handleTrailingData = function () {
          ...
          if (this.state === s.InCommentLike) {
            ...
            this.cbs.context(this.sectionStart, e);
          }
        };
    ...
    48115: (e, t, r) => {
      ...
      function a(e) {
        var t, r;
        var i =
          (r = (t = f("channel", e.children)) === null || t === void 0 ? void 0 : t.children) !== null && r !== void 0
            ? r
            : [];
        var s = {
        ...
        const j = new i.Parser(
          {
            ...
            onclosetag: function (e, r) {
              ...
              if (
                ...
                (r && !S(e) && ["escape", "recursiveEscape"].indexOf(t.disallowedTagsMode) >= 0)
              ) {
                if (n) {
                  v = w;
                  w = "";
