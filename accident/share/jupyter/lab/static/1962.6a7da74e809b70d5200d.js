    ...
    91962: (e, t, a) => {
      ...
      function ce(e, t) {
        ...
        for (let n of e.getChildren(q)) {
          ...
          if (e)
            a[t.read(e.from, e.to)] = !l ? "" : l.type.id == $ ? t.read(l.from + 1, l.to - 1) : t.read(l.from, l.to);
        }
        return a;
      }
      function de(e, t) {
      ...
      function Be(e, t, a, n) {
        ...
        return {
          from: a,
          to: n,
          options: ke(e.doc, t).map((e, t) => ({ label: e, apply: e + l, type: "type", boost: 99 - t })),
          validFor: Ye,
        };
      }
      function Ge(e, t, a, n) {
          ...
          props: [
            xe.indentNodeProp.add({
              ...
              Document(e) {
                ...
                if (t && !((a = t.lastChild) && (a.name == "CloseTag" || a.name == "SelfClosingTag")))
      ...
      const ze = ge.EditorView.inputHandler.of((e, t, a, n, l) => {
        if (e.composing || e.state.readOnly || t != a || (n != ">" && n != "/") || !Ue.isActiveAt(e.state, t, -1))
          return false;
        let r = l(),
          { state: s } = r;
        let o = s.changeByRange((e) => {
          ...
          if (r && n == ">" && u.name == "EndTag") {
            let n = u.parent;
            if (
              ((a = (t = n.parent) === null || t === void 0 ? void 0 : t.lastChild) === null || a === void 0
                ? void 0
                : a.name) != "CloseTag" &&
