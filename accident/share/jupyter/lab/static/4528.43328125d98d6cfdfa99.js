...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [4528],
  {
    24528: (e, t, n) => {
      ...
      function a(e, t, n, a) {
        var i = e.indented;
        if (e.context && e.context.type == "statement" && n != "statement") i = e.context.indented;
      ...
      function o(e, t, n) {
        ...
        if (/\S(?:[^- ]>|[*\]])\s*$|\*$/.test(e.string.slice(0, n))) return true;
      ...
      function s(e) {
        var t = e.statementIndentUnit,
          ...
          v = e.numberStart || /[\d\.]/,
          _ = e.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
          x = e.isOperatorChar || /[+\-*&%=<>!?|\/]/,
        ...
        function L(t, n) {
          if (e.typeFirstDefinitions && t.eol() && l(n.context)) n.typeAtEndOfLine = o(t, n, t.pos);
        }
        return {
          name: e.name,
          ...
          token: function (t, n) {
            ...
            if (N == ";" || N == ":" || (N == "," && t.match(/^\s*(?:\/\/.*)?$/, false)))
              ...
              g &&
              (((r.type == "}" || r.type == "top") && N != ";") || (r.type == "statement" && N == "newstatement"))
            ) {
            ...
            if (
              s == "variable" &&
              (n.prevToken == "def" ||
                (e.typeFirstDefinitions && o(t, n, t.start) && l(n.context) && t.match(/^\s*\(/, false)))
            )
              s = "def";
            if (h.token) {
              var c = h.token(t, n, s);
          ...
          indent: function (r, a, i) {
            if ((r.tokenize != I && r.tokenize != null) || (r.typeAtEndOfLine && l(r.context))) return null;
            var o = r.context,
              s = a && a.charAt(0);
            var c = s == o.type;
            if (o.type == "statement" && s == "}") o = o.prev;
            if (e.dontIndentStatements) while (o.type == "statement" && e.dontIndentStatements.test(o.info)) o = o.prev;
            if (h.indent) {
            ...
            if (o.type == "statement") return o.indented + (s == "{" ? 0 : t || i.unit);
            if (o.align && (!n || o.type != ")")) return o.column + (c ? 0 : 1);
            if (o.type == ")" && !c) return o.indented + (t || i.unit);
            return o.indented + (c ? 0 : i.unit) + (!c && f && !/^(?:case|default)\b/.test(a) ? i.unit : 0);
          },
          languageData: {
            indentOnInput: k ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
            commentTokens: { line: "//", block: { open: "/*", close: "*/" } },
            autocomplete: Object.keys(s).concat(Object.keys(c)).concat(Object.keys(f)).concat(Object.keys(m)),
            ...e.languageData,
          },
        };
      }
      ...
      var h = c("int long char short double float unsigned signed " + "void bool");
        ...
        hooks: {
          ...
          "=": function (e, t) {
            ...
            if (n.type == "}" && n.align && e.eat(">")) {
              t.context = new r(n.indented, n.column, n.type, n.info, null, n.prev);
              return "operator";
            } else {
              return false;
            }
      ...
      const $ = s({
        ...
        defKeywords: c(w + " @interface @implementation @protocol @class class namespace"),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: true,
        atoms: c("YES NO NULL Nil nil true false nullptr"),
        isReservedIdentifier: x,
