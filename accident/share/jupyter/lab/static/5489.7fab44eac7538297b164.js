    ...
    25489: (e, t, r) => {
      ...
      var Q = function e(t, r) {
        switch (t) {
          ...
          case "lfloor":
            return (
              "M319 602 V0 H403 V602 v" + r + " v1715 h263 v84 H319z\nMM319 602 V0 H403 V602 v" + r + " v1715 H319z"
            );
          case "rfloor":
            return (
              "M319 602 V0 H403 V602 v" + r + " v1799 H0 v-84 H319z\nMM319 602 V0 H403 V602 v" + r + " v1715 H319z"
            );
          case "lceil":
            return (
              "M403 1759 V84 H666 V0 H319 V1759 v" + r + " v602 h84z\nM403 1759 V0 H319 V1759 v" + r + " v602 h84z"
            );
          case "rceil":
      ...
      var yt = function e(t, r, a, i, n) {
        ...
        if (o) {
          ...
          typeof console !== "undefined" &&
            console.warn("No character metrics " + ("for '" + t + "' in style '" + r + "' and mode '" + a + "'"));
      ...
      var si = (e, t) => {
        var r = new vr.MathNode("mfrac", [Sr(e.number, t), Sr(e.denom, t)]);
        if (!e.hasBarLine) {
            ...
            if (n) {
              if (!s) {
                r.settings.reportNonstrict(
                  "mathVsTextUnits",
                  "LaTeX's " + a + " supports only mu units, " + ("not " + i.value.unit + " units"),
                );
              }
              if (r.mode !== "math") {
      ...
      $t({
        ...
        htmlBuilder(e, t) {
          ...
          if (o && l) {
            ...
            u = Math.max(u, f, o.depth + 0.25 * h.xHeight);
            w = Vt.makeVList(
              { positionType: "shift", positionData: -u, children: [{ type: "elem", elem: o, marginRight: b }] },
              t,
            );
          } else {
        ...
        consumeArg(e) {
          ...
          do {
            ...
            if (i.text === "{") {
              ...
              throw new n(
                "Unexpected end of input in a macro argument" + ", expected '" + (e && r ? e[o] : "}") + "'",
                i,
              );
            }
            if (e && r) {
