        ...
        function (e, r, t) {
          ...
          p.propTypes = {
            ...
            searchWords: s["default"].arrayOf(
              s["default"].oneOfType([s["default"].string, s["default"].instanceOf(RegExp)]),
            ).isRequired,
          ...
          e.exports = (function (e) {
            ...
            function (e, r) {
              ...
              var t = (r.findAll = function e(r) {
                ...
                return i({
                  chunksToHighlight: n({
                    chunks: f({ autoEscape: t, caseSensitive: o, sanitize: l, searchWords: c, textToHighlight: p }),
                  }),
            ...
            e.exports = function (e, t) {
              ...
              function b(e) {
                function r(r, t, n, a, i) {
                  if (typeof e !== "function") {
                    return new h(
                      "Property `" + i + "` of component `" + n + "` has invalid PropType notation inside arrayOf.",
                    );
                  }
                  var u = r[t];
                  if (!Array.isArray(u)) {
                    ...
                    return new h(
                      "Invalid " +
                        ...
                        i +
                        "` of type " +
                        ("`" + s + "` supplied to `" + n + "`, expected an array."),
                    );
                  }
              ...
              function w(e) {
                if (!Array.isArray(e)) {
                  r.env.NODE_ENV !== "production"
                    ? i(false, "Invalid argument supplied to oneOf, expected an instance of array.")
                    : void 0;
              ...
              function T(e) {
                function r(r, t, n, a, i) {
                  if (typeof e !== "function") {
                    return new h(
                      "Property `" + i + "` of component `" + n + "` has invalid PropType notation inside objectOf.",
                    );
                  }
                  var u = r[t];
                  var s = P(u);
                  if (s !== "object") {
                    return new h(
                      "Invalid " +
                        ...
                        i +
                        "` of type " +
                        ("`" + s + "` supplied to `" + n + "`, expected an object."),
                    );
                  }
                  for (var f in u) {
              ...
              function E(e) {
                if (!Array.isArray(e)) {
                  r.env.NODE_ENV !== "production"
                    ? i(false, "Invalid argument supplied to oneOfType, expected an instance of array.")
                    : void 0;
                  return n.thatReturnsNull;
                }
