    ...
    95566: (e, t, r) => {
      ...
      function a(e) {
        ...
        function h(e, l) {
          ...
          if (
            s.hexNumber &&
            ((c == "0" && e.match(/^[xX][0-9a-fA-F]+/)) || ((c == "x" || c == "X") && e.match(/^'[0-9a-fA-F]*'/)))
          ) {
            return "number";
          } else if (
            s.binaryNumber &&
            (((c == "b" || c == "B") && e.match(/^'[01]+'/)) || (c == "0" && e.match(/^b[01]*/)))
          ) {
            return "number";
            ...
            ((s.nCharCast && (c == "n" || c == "N")) || (s.charsetCast && c == "_" && e.match(/[a-z][a-z0-9]*/i))) &&
            (e.peek() == "'" || e.peek() == '"')
          ) {
            return "keyword";
          } else if (
            ...
            if (s.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)) return "number";
            ...
            c == "{" &&
            (e.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || e.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))
          ) {
            return "number";
          } else {
            e.eatWhile(/^[_\w\d]/);
            var m = e.current().toLowerCase();
            if (d.hasOwnProperty(m) && (e.match(/^( )+'[^']*'/) || e.match(/^( )+"[^"]*"/))) return "number";
      ...
      const x = a({
        ...
        operatorChars: /^[*+\-%<>!=&|^\/#@?~]/,
        dateSQL: c("date time timestamp"),
        support: c("ODBCdotTable decimallessFloat zerolessFloat binaryNumber hexNumber nCharCast charsetCast"),
      });
      const w = a({
        keywords: c(
