(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [1423, 5606],
  {
    75128: (t, e, s) => {
      "use strict";
      s.d(e, { Ar: () => d, Bc: () => Qt, Gw: () => Ot, _5: () => h, et: () => u, wm: () => Wt });
      var i = s(71674);
      var n = s.n(i);
      var o = s(22819);
      var r = s.n(o);
        ...
        return Object.assign(
          Object.assign(
            ...
            t.changeByRange((a) => {
              ...
              let h = t.toText(e);
              return {
                changes: { from: a.from + r, to: n == o.from ? a.to : a.from + l, insert: h },
      ...
      class R {
        constructor(t, e, s) {
          ...
          this.dom.addEventListener("focusout", (e) => {
            ...
            if (s && s.tooltip && t.state.facet(T).closeOnBlur && e.relatedTarget != t.contentDOM)
        ...
        updateSel() {
          ...
          if ((e.selected > -1 && e.selected < this.range.from) || e.selected >= this.range.to) {
            this.range = D(e.options.length, e.selected, this.view.state.facet(T).maxRenderedOptions);
        ...
        measureInfo() {
          ...
          if (!n) {
            ...
            n = { left: 0, top: 0, right: t.clientWidth, bottom: t.clientHeight };
          }
      ...
      function B(t, e) {
        ...
        if (i) {
          ...
          let n = (t, e) => {
            var s, i;
            return (
              ((s = t.rank) !== null && s !== void 0 ? s : 1e9) - ((i = e.rank) !== null && i !== void 0 ? i : 1e9) ||
              (t.name < e.name ? -1 : 1)
            );
          };
      ...
      class M {
        ...
        setSelected(t, e) {
          return t == this.selected || t >= this.options.length
            ? this
            : new M(this.options, U(e, t), this.tooltip, this.timestamp, t, this.disabled);
        }
        static build(t, e, s, i, n, o) {
          if (i && !o && t.some((t) => t.isPending)) return i.setDisabled();
          let r = B(t, e);
          if (!r.length) return i && t.some((t) => t.isPending) ? i.setDisabled() : null;
        ...
        setDisabled() {
          return new M(this.options, this.attrs, this.tooltip, this.timestamp, this.selected, true);
        }
      }
      class z {
        constructor(t, e, s) {
        ...
        static start() {
          return new z(W, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
        }
        update(t) {
          let { state: e } = t,
            s = e.facet(T);
          ...
          let n = i.map((e) => {
            let i = this.active.find((t) => t.source == e) || new q(e, this.active.some((t) => t.state != 0) ? 1 : 0);
            return i.update(t, s);
          });
          ...
          if (!o && n.every((t) => !t.isPending) && n.some((t) => t.hasResult()))
            n = n.map((t) => (t.hasResult() ? new q(t.source, 0) : t));
          for (let l of t.effects) if (l.is(K)) o = o && o.setSelected(l.value, this.id);
      ...
      class q {
        ...
        update(t, e) {
          ...
          for (let n of t.effects) {
            ...
            else if (n.is(_)) for (let t of n.value) if (t.source == i.source) i = t;
          }
          return i;
        }
        updateFor(t, e) {
      ...
      class H extends q {
        ...
        updateFor(t, e) {
          ...
          let r = g(t.state);
          if (r > o || !i || (e & 2 && (g(t.startState) == this.from || r < this.limit)))
            return new q(this.source, e & 4 ? 1 : 0);
          let l = t.changes.mapPos(this.limit);
          if (G(i.validFor, t.state, n, o)) return new H(this.source, this.explicit, l, i, n, o);
      ...
      function X(t, e) {
        ...
        if (typeof s == "string")
          t.dispatch(
            Object.assign(Object.assign({}, x(t.state, s, i.from, i.to)), { annotations: b.of(e.completion) }),
          );
      ...
      function J(t, e = "option") {
        return (s) => {
          ...
          if (!i || !i.open || i.open.disabled || Date.now() - i.open.timestamp < s.state.facet(T).interactionDelay)
            return false;
          let n = 1,
            r;
      ...
      const ot = o.ViewPlugin.fromClass(
        class {
          constructor(t) {
            ...
            this.composing = 0;
            for (let e of t.state.field(Q).active) if (e.isPending) this.startQuery(e);
          }
          update(t) {
            let e = t.state.field(Q);
            let s = t.state.facet(T);
            if (!t.selectionSet && !t.docChanged && t.startState.field(Q) == e) return;
            ...
            for (let l = 0; l < this.running.length; l++) {
              ...
              if (
                ...
                (e.updates.length + t.transactions.length > it && Date.now() - e.time > nt)
              ) {
            ...
            this.debounceUpdate = e.active.some(
              (t) => t.isPending && !this.running.some((e) => e.active.source == t.source),
            )
          ...
          startUpdate() {
            ...
            for (let s of e.active) {
              if (s.isPending && !this.running.some((t) => t.active.source == s.source)) this.startQuery(s);
            }
            if (this.running.length && e.open && e.open.disabled)
              this.debounceAccept = setTimeout(() => this.accept(), this.view.state.facet(T).updateSyncTime);
          }
          startQuery(t) {
          ...
          accept() {
            ...
            for (let n = 0; n < this.running.length; n++) {
              ...
              if (o.done) {
                let i = g(o.updates.length ? o.updates[0].startState : this.view.state);
            ...
            if (e.length || (i.open && i.open.disabled)) this.view.dispatch({ effects: _.of(e) });
          }
        },
        {
          eventHandlers: {
            blur(t) {
              ...
              if (e && e.tooltip && this.view.state.facet(T).closeOnBlur) {
                ...
                if (!s || !s.dom.contains(t.relatedTarget))
                  setTimeout(() => this.view.dispatch({ effects: S.of(null) }), 10);
              }
            },
            compositionstart() {
              this.composing = 1;
      ...
      class ft {
        ...
        instantiate(t, e) {
          ...
          let r = this.fieldPositions.map((t) => new ct(t.field, i[t.line] + t.from, i[t.line] + t.to));
          ...
          for (let o of t.split(/\r\n?|\n/)) {
            while ((n = /[#$]\{(?:(\d+)(?::([^}]*))?|((?:\\[{}]|[^}])*))\}/.exec(o))) {
              ...
              for (let s = 0; s < e.length; s++) {
                if (t != null ? e[s].seq == t : a ? e[s].name == a : false) l = s;
              }
              if (l < 0) {
                let s = 0;
      ...
      class dt {
        constructor(t, e) {
          this.ranges = t;
          this.active = e;
          this.deco = o.Decoration.set(t.map((t) => (t.from == t.to ? ut : pt).range(t.from, t.to)));
        }
        map(t) {
          let e = [];
        ...
        selectionInsideField(t) {
          return t.ranges.every((t) =>
            this.ranges.some((e) => e.field == this.active && e.from <= t.from && e.to >= t.to),
          );
        }
      }
      ...
      function bt(t, e) {
        return i.EditorSelection.create(
          t.filter((t) => t.field == e).map((t) => i.EditorSelection.range(t.from, t.to)),
        );
      }
      function xt(t) {
        let e = ft.parse(t);
        return (t, s, n, o) => {
          ...
          let h = {
            changes: { from: n, to: o == a.from ? a.to : o, insert: i.Text.of(r) },
            scrollIntoView: true,
          ...
          if (l.some((t) => t.field > 0)) {
            ...
            if (t.state.field(kt, false) === undefined) s.push(i.StateEffect.appendConfig.of([kt, It, Dt, at]));
          }
      ...
      const Dt = o.EditorView.domEventHandlers({
        mousedown(t, e) {
          ...
          e.dispatch({
            ...
            effects: mt.of(s.ranges.some((t) => t.field > n.field) ? new dt(s.ranges, n.field) : null),
            scrollIntoView: true,
          });
          return true;
        },
      ...
      const Ft = { brackets: ["(", "[", "{", "'", '"'], before: ")]}:;>", stringPrefixes: [] };
      ...
      const Ut = i.StateField.define({
        ...
        update(t, e) {
          ...
          for (let s of e.effects) if (s.is($t)) t = t.update({ add: [jt.range(s.value, s.value + 1)] });
          return t;
        },
      });
      function Wt() {
      ...
      const Vt = "()[]{}<>«»»«［］｛｝";
      function qt(t) {
        for (let e = 0; e < Vt.length; e += 2) if (Vt.charCodeAt(e) == t) return Vt.charAt(e + 1);
        return (0, i.fromCodePoint)(t < 128 ? t : t + 1);
      }
      function Ht(t, e) {
        return t.languageDataAt("closeBrackets", e)[0] || Ft;
      }
      const Gt = typeof navigator == "object" && /Android\b/.test(navigator.userAgent);
      const _t = o.EditorView.inputHandler.of((t, e, s, n) => {
        if ((Gt ? t.composing : t.compositionStarted) || t.state.readOnly) return false;
        let o = t.state.selection.main;
        if (
          n.length > 2 ||
          (n.length == 2 && (0, i.codePointSize)((0, i.codePointAt)(n, 0)) == 1) ||
          e != o.from ||
          s != o.to
        )
          return false;
      ...
      function Xt(t, e) {
        ...
        for (let o of n) {
          ...
          if (e == o) return r == o ? se(t, o, n.indexOf(o + o + o) > -1, s) : te(t, o, r, s.before || Ft.before);
      ...
      const ae = i.Prec.highest(o.keymap.computeN([T], (t) => (t.facet(T).defaultKeymap ? [le] : [])));
      function he(t) {
      ...
      function fe(t) {
        var e;
        let s = (e = t.field(Q, false)) === null || e === void 0 ? void 0 : e.open;
            ...
            for (let t = o.stateSlot(n, l ? 2 : 1); ; t += 3) {
              if (r[t] == 65535) {
                if (r[t + 1] == 1) {
                  ...
                  if (i == 0 && r[t + 1] == 2) i = this.putAction(R(r, t + 2), e, s, i);
                  break;
                }
              }
      ...
      class D extends i.Parser {
        ...
        parseDialect(t) {
          ...
          for (let n = 0; n < e.length; n++)
            if (!s[n]) {
              for (let t = this.dialects[e[n]], s; (s = this.data[t++]) != 65535; )
