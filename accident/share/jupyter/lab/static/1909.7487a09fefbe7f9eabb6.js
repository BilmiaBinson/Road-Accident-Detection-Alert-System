...
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([
  [1909],
  {
    ...
    92902: function (e, t, r) {
      ...
      var f = (function (e) {
        ...
        function t(t) {
          ...
          n.factory.configuration.tags.start("multiline", true, r[0]);
          return n;
        }
    ...
    97403: function (e, t, r) {
      ...
      new l.EnvironmentMap(
        ...
        c.default.environment,
        {
          ...
          multiline: ["Multiline", null, true],
          "multiline*": ["Multiline", null, false],
    ...
    98840: function (e, t, r) {
      ...
      t.AmsMethods.Multiline = function (e, t, r) {
        e.Push(t);
        i.default.checkEqnEnv(e);
        var a = e.itemFactory.create("multiline", r, e.stack);
        a.arraydef = {
          displaystyle: true,
          rowspacing: ".5em",
          columnspacing: "100%",
      ...
      t.AmsMethods.HandleDeclareOp = function (e, r) {
        ...
        e.configuration.handlers
          .retrieve(t.NEW_OPS)
          .add(n, new d.Macro(n, t.AmsMethods.Macro, ["\\operatorname".concat(a, "{").concat(o, "}")]));
      };
      ...
      t.AmsMethods.HandleShove = function (e, t, r) {
        var a = e.stack.Top();
        if (a.kind !== "multiline") {
          throw new f.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment", e.currentCS, "multiline");
        }
        if (a.Size()) {
            ...
            if (v || g) {
              ...
              if (v) {
                s.default.appendChildren(d, [
                  new n.default("\\scriptstyle\\llap{" + v + "}", e.stack.env, e.configuration).mml(),
                ]);
              }
              ...
              if (g) {
                s.default.appendChildren(d, [
                  new n.default("\\scriptstyle\\rlap{" + g + "}", e.stack.env, e.configuration).mml(),
                ]);
              }
            }
          }
    ...
    22792: function (e, t, r) {
      ...
      s.Braket = function (e, t, r, a, n, o) {
        ...
        e.Push(
          e.itemFactory
            .create("braket")
            .setProperties({ barmax: o, barcount: 0, open: r, close: a, stretchy: n, single: l }),
        );
      };
      s.Bar = function (e, t) {
        var r = t === "|" ? "|" : "∥";
    ...
    86158: function (e, t, r) {
      ...
      p.Prooftree = function (e, t) {
        ...
        var r = e.itemFactory
          .create("proofTree")
          .setProperties({ name: t.getName(), line: "solid", currentLine: "solid", rootAtTop: false });
        return r;
      };
    ...
    2362: function (e, t, r) {
      ...
      new i.CommandMap(
        "cancel",
        {
          ...
          xcancel: [
            "Cancel",
            o.TexConstant.Notation.UPDIAGONALSTRIKE + " " + o.TexConstant.Notation.DOWNDIAGONALSTRIKE,
          ],
          cancelto: "CancelTo",
        },
        t.CancelMethods,
          ...
          CenterOver: function (e, t) {
            ...
            var o = e.create("node", "TeXAtom", [
              ...
              e.create(
                "node",
                "mpadded",
                [e.create("node", "mpadded", [a], { width: 0, lspace: "-.5width" }), e.create("node", "mphantom", [n])],
    ...
    99118: function (e, t, r) {
      ...
      t.EmpheqUtil = {
        ...
        right: function (e, r, a, n, o) {
          ...
          e.attributes.set(
            "columnalign",
            (e.attributes.get("columnalign") || "").split(/ /).slice(0, i).join(" ") + " left",
          );
          e.attributes.set(
            "columnspacing",
        ...
        allowEnv: { equation: true, align: true, gather: true, flalign: true, alignat: true, multiline: true },
        checkEnv: function (e) {
    ...
    75316: function (e, t, r) {
      ...
      t.MathtoolsMethods = {
        ...
        HandleShove: function (e, t, r) {
          var a = e.stack.Top();
          if (a.kind !== "multiline" && a.kind !== "multlined") {
            throw new f.default(
              "CommandInMultlined",
              "%1 can only appear within the multiline or multlined environments",
              t,
            );
          }
          if (a.Size()) {
          ...
          var i = e.create(
            ...
            [
              e.create(
                ...
                "mpadded",
                [e.ParseArg(t)],
                a({ width: 0 }, r === "r" ? {} : { lspace: r === "l" ? "-1width" : "-.5width" }),
              ),
            ],
            { "data-cramped": n },
          );
                    ...
                    e.create(
                      ...
                      [
                        e.create(
                          "node",
                          "menclose",
                          [e.create("node", "mspace", [], { height: ".2em", depth: 0, width: ".4em" })],
                ...
                e.create(
                  ...
                  [
                    e.create(
                      "node",
                      "mstyle",
                      [a, e.create("token", "mi"), e.create("token", "mspace", { width: "1em" })],
                      { scriptlevel: 0 },
                    ),
                    e.create(
                      "node",
                      "mstyle",
                      [e.create("token", "mspace", { width: "1em" }), e.create("token", "mi"), n],
                      { scriptlevel: 0 },
                    ),
                  ],
            ...
            e.create(
              ...
              [
                e.create(
                  "node",
                  "mpadded",
                  [e.create("node", "mphantom", [e.create("token", "mo", { stretchy: false }, "(")])],
      ...
      t.MathtoolsUtil = {
        ...
        checkAlignment: function (e, t) {
          ...
          if (r.kind !== o.EqnArrayItem.prototype.kind) {
            throw new l.default("NotInAlignment", "%1 can only be used in alignment environments", t);
          }
          return r;
        },
      ...
      var n = {
        ...
        patterns: {
          patterns: {
            ...
            "${(...)}$__$(...)$": function (e) {
              return (
                n.patterns.findObserveGroups(e, "${", "", "", "}$") || n.patterns.findObserveGroups(e, "$", "", "", "$")
              );
            },
            "=<>": /^[=<>]/,
            "#": /^[#\u2261]/,
        ...
        stateMachines: {
          ...
          ce: {
            transitions: a({
              ...
              "-": {
                "0|1|2": {
                  action_: [{ type_: "output", option: 1 }, "beginsWithBond=true", { type_: "bond", option: "-" }],
                  nextState: "3",
                },
