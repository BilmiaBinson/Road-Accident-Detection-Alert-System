    ...
    91208: (e, t, r) => {
        ...
        if (n)
          for (let l = e, o = l.parent; o; l = o, o = l.parent) {
            if (
              l instanceof w &&
              l.index < 0 &&
              ((i = o.enter(t, r, s)) === null || i === void 0 ? void 0 : i.from) != l.from
            )
              e = o;
          }
        for (;;) {
      ...
      class I {
        ...
        enterChild(e, t, r) {
          if (!this.buffer)
            return this.yield(
              this._tree.nextChild(e < 0 ? this._tree._tree.children.length - 1 : 0, e, t, r, this.mode),
            );
        ...
        advance() {
          ...
          if (this.innerDone == this.inner.length) {
            ...
            if (this.stoppedAt != null)
              e = new c(e.type, e.children, e.positions, e.length, e.propValues.concat([[L, this.stoppedAt]]));
            return e;
          }
              ...
              if (t) {
                ...
                if (e)
                  for (let r of e.mount.overlay) {
                    let i = r.from + e.pos,
                      s = r.to + e.pos;
                    if (i >= n.from && s <= n.to && !t.ranges.some((e) => e.from < s && e.to > i))
