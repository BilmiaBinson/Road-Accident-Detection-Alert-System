...
(() => {
  ...
  var e,
    ...
    S = {
      215: (e, r, t) => {
        var o = {
            "./index": () => Promise.all([t.e(981), t.e(568)]).then(() => () => t(568)),
            "./extension": () => Promise.all([t.e(981), t.e(568)]).then(() => () => t(568)),
  ...
  ((x.m = S),
    ...
    (x.u = (e) =>
      ...
      "." +
      {
        ...
        557: "2f882aef2c303890736d",
        568: "0143b064f4b09edb4d20",
        928: "7e52f03b261ea07bcb3d",
        981: "249db229afef349774bb",
      }[e] +
      ".js?v=" +
      {
        93: "eae3497dd223d842d198",
    ...
    (() => {
      ...
      x.I = (t, o) => {
        ...
        if ((n || (n = r[t] = {}), !(o.indexOf(n) >= 0))) {
          ...
          return (
            "default" === t &&
              (l("@jupyter-notebook/application", "7.4.4", () =>
                Promise.all([x.e(928), x.e(557), x.e(981)]).then(() => () => x(30)),
              ),
              l("@jupyter-notebook/lab-extension", "7.4.4", () =>
                Promise.all([x.e(981), x.e(568)]).then(() => () => x(568)),
              )),
    ...
    (n = (e) => {
      ...
      if (r + 0.5) {
        ...
        for (var o = 1, a = 1; a < e.length; a++)
          (o--, (t += "u" == (typeof (l = e[a]))[0] ? "-" : (o > 0 ? "." : "") + ((o = 2), l)));
        return t;
      }
      var i = [];
    ...
    (j = {}),
    (w = {
      82: () => g("default", "@jupyterlab/coreutils", [1, 6, 4, 4]),
      238: () => g("default", "@jupyterlab/apputils", [1, 4, 5, 4]),
      342: () => g("default", "@jupyterlab/application", [1, 4, 4, 4]),
      399: () => g("default", "@jupyterlab/ui-components", [1, 4, 4, 4]),
      882: () => g("default", "@lumino/widgets", [1, 2, 3, 1, , "alpha", 0]),
      916: () => g("default", "@jupyterlab/translation", [1, 4, 4, 4]),
      779: () => g("default", "@jupyterlab/notebook", [1, 4, 4, 4]),
      976: () =>
        y("default", "@jupyter-notebook/application", [1, 7, 4, 4], () =>
          Promise.all([x.e(928), x.e(557)]).then(() => () => x(30)),
        ),
      4: () => g("default", "@lumino/properties", [1, 2, 0, 0]),
      12: () => g("default", "@jupyterlab/rendermime", [1, 4, 4, 4]),
      27: () => m("default", "@jupyterlab/docregistry", [1, 4, 4, 4]),
    ...
    (k = { 557: [4, 12, 27, 633, 697, 717, 797, 901, 930], 568: [779, 976], 981: [82, 238, 342, 399, 882, 916] }),
    (x.f.consumes = (e, r) => {
      x.o(k, e) &&
        k[e].forEach((e) => {
