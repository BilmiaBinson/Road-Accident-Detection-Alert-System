      ...
      !(function (t) {
          ...
          return r && r.type
            ? "tab-area" === r.type
              ? {
                  ...
                  widgets: r.widgets.map((e) => t.nameProperty.get(e)).filter((t) => !!t),
                }
              : {
                  type: "split-area",
        ...
        function r(t, e) {
          ...
          if ("unknown" === n || ("tab-area" !== n && "split-area" !== n))
            return (console.warn(`Attempted to deserialize unknown type: ${n}`), null);
          if ("tab-area" === n) {
                        ...
                        ((c = Array.isArray(e.documentWidgetFactoryOptions)
                          ...
                          e.fileTypes &&
                            e.fileTypes.forEach((t) => {
                              (t.icon && (t = { ...t, icon: s.LabIcon.resolve({ icon: t.icon }) }),
