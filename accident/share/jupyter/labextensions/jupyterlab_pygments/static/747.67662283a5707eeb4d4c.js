          ...
          (o.toString = function () {
            return this.map(function (o) {
              ...
              return (
                ...
                e && (t += "@layer".concat(o[5].length > 0 ? " ".concat(o[5]) : "", " {")),
                (t += r(o)),
                e && (t += "}"),
                o[2] && (t += "}"),
                o[4] && (t += "}"),
          ...
          (o.i = function (r, t, e, i, n) {
            ...
            for (var h = 0; h < r.length; h++) {
              ...
              (e && l[g[0]]) ||
                (void 0 !== n &&
                  (void 0 === g[5] ||
                    (g[1] = "@layer".concat(g[5].length > 0 ? " ".concat(g[5]) : "", " {").concat(g[1], "}")),
                  (g[5] = n)),
                t && (g[2] ? ((g[1] = "@media ".concat(g[2], " {").concat(g[1], "}")), (g[2] = t)) : (g[2] = t)),
                i &&
                  (g[4]
                    ? ((g[1] = "@supports (".concat(g[4], ") {").concat(g[1], "}")), (g[4] = i))
                    : (g[4] = "".concat(i))),
                o.push(g));
            }
          }),
    ...
    379: (r) => {
      ...
      function e(r, e) {
        for (var n = {}, l = [], c = 0; c < r.length; c++) {
          ...
          n[h] = g + 1;
          var d = t(s),
            p = { css: a[1], media: a[2], sourceMap: a[3], supports: a[4], layer: a[5] };
          if (-1 !== d) (o[d].references++, o[d].updater(p));
          else {
            var m = i(p, e);
            ((e.byIndex = c), o.splice(c, 0, { identifier: s, updater: m, references: 1 }));
          }
          l.push(s);
        }
        return l;
        ...
        return {
          update: function (t) {
            !(function (r, o, t) {
              ...
              (i && (e += "@layer".concat(t.layer.length > 0 ? " ".concat(t.layer) : "", " {")),
                (e += t.css),
                i && (e += "}"),
                t.media && (e += "}"),
                t.supports && (e += "}"));
